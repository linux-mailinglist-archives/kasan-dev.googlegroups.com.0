...
Received: from mail-il1-x139.google.com (mail-il1-x139.google.com [IPv6:2607:f8b0:4864:20::139])
	by mail.lfdr.de (Postfix) with ESMTPS id A12F517E7CC
	for <lists+kasan-dev@lfdr.de>; Mon,  9 Mar 2020 20:04:26 +0100 (CET)
Received: by mail-il1-x139.google.com with SMTP id a2sf8052635ill.13
        for <lists+kasan-dev@lfdr.de>; Mon, 09 Mar 2020 12:04:26 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1583780665; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:references:in-reply-to:message-id
         :date:subject:cc:to:from:mime-version:sender:dkim-signature;
        bh=b1x3sv1UhA9Zy0TeCWrSXx/Ap5nLJd/RUJ3USR1g4+M=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@kernel.org header.s=default header.b=ZyBBDKTZ;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=b1x3sv1UhA9Zy0TeCWrSXx/Ap5nLJd/RUJ3USR1g4+M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=sender:x-gm-message-state:mime-version:from:to:cc:subject:date
         ...
         :list-subscribe:list-unsubscribe;
        bh=b1x3sv1UhA9Zy0TeCWrSXx/Ap5nLJd/RUJ3USR1g4+M=;
        b=
Sender: kasan-dev@googlegroups.com
X-Gm-Message-State: ANhLgQ1WukK/JYlCFBni+vpStb2szQyTwT9PCB8STWfvEweHGRtESSV2
	An2uuUBR2KFbi/F7ezWahVA=
X-Google-Smtp-Source: ADFU+vtAzBFmiurpamiJPusDJi5TcuwORFjeZkm4kVIEi4H9hwF15VFyjzTtRYZ7g46wY0qNmUrnUA==
X-Received: by 2002:a02:a00d:: with SMTP id a13mr16937677jah.8.1583780665455;
        Mon, 09 Mar 2020 12:04:25 -0700 (PDT)
MIME-Version: 1.0
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a5d:924d:: with SMTP id e13ls1556110iol.0.gmail; Mon, 09 Mar
 2020 12:04:25 -0700 (PDT)
X-Received: by 2002:a6b:fe13:: with SMTP id x19mr3714988ioh.152.1583780664599;
        Mon, 09 Mar 2020 12:04:24 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1583780664; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=references:in-reply-to:message-id:date:subject:cc:to:from
         :dkim-signature;
        bh=GyI25H0OqgK+GfTjlQhlL5+4OAVmZTglxQK4ZUvUU3c=;
        b=
...
Received: from mail.kernel.org (mail.kernel.org. [198.145.29.99])
        by gmr-mx.google.com with ESMTPS id k88si145986ilg.1.2020.03.09.12.04.24
...
Received: from paulmck-ThinkPad-P72.home (50-39-105-78.bvtn.or.frontiernet.net [50.39.105.78])
	...
	by mail.kernel.org (Postfix) with ESMTPSA id A5CE82464B;
...
Subject: [PATCH kcsan 07/32] asm-generic, atomic-instrumented: Use generic instrumented.h
Date: Mon,  9 Mar 2020 12:03:55 -0700
Message-Id: <20200309190420.6100-7-paulmck@kernel.org>
X-Mailer: git-send-email 2.9.5
In-Reply-To: <20200309190359.GA5822@paulmck-ThinkPad-P72>
References: <20200309190359.GA5822@paulmck-ThinkPad-P72>
X-Original-Sender: paulmck@kernel.org
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@kernel.org header.s=default header.b=ZyBBDKTZ;       spf=pass
...
To view this discussion on the web visit https://groups.google.com/d/msgid/kasan-dev/20200309190420.6100-7-paulmck%40kernel.org.
