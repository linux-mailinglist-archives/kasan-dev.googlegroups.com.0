Return-Path: <kasan-dev+bncBC7OBJGL2MHBB4WHWT4QKGQEV6IDMCY@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-lj1-x23e.google.com (mail-lj1-x23e.google.com [IPv6:2a00:1450:4864:20::23e])
	by mail.lfdr.de (Postfix) with ESMTPS id 51CE323EAE8
	for <lists+kasan-dev@lfdr.de>; Fri,  7 Aug 2020 11:50:43 +0200 (CEST)
Received: by mail-lj1-x23e.google.com with SMTP id r28sf310897ljm.6
        for <lists+kasan-dev@lfdr.de>; Fri, 07 Aug 2020 02:50:43 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1596793842; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        bh=b/2P/mz1J7uByIbcPxNas4HfkrF5cKxyU3KIJ1nh33M=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@google.com header.s=20161025 header.b=R28NnxXR;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=date:from:to:cc:subject:message-id:references:mime-version
         ...
         :list-unsubscribe;
        bh=b/2P/mz1J7uByIbcPxNas4HfkrF5cKxyU3KIJ1nh33M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=b/2P/mz1J7uByIbcPxNas4HfkrF5cKxyU3KIJ1nh33M=;
        b=
X-Gm-Message-State: AOAM531AAtKtM/apTOr38500NaiJaPb5EsNplqHDuH0KuVoO3Y/Xtt/F
	G0Mca06lE+NFfW16xtJp4Hw=
X-Google-Smtp-Source: ABdhPJzrtsv828ym+M5AxH+jvwYZ+xWrSKbZRg0VHs0ZuGkBy+XyEI6eX69Wu4lI27MGL8qZdV0QZw==
X-Received: by 2002:a2e:a0d5:: with SMTP id f21mr6385537ljm.364.1596793842591;
        Fri, 07 Aug 2020 02:50:42 -0700 (PDT)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a2e:300f:: with SMTP id w15ls1627344ljw.1.gmail; Fri, 07 Aug
 2020 02:50:41 -0700 (PDT)
X-Received: by 2002:a05:651c:1293:: with SMTP id 19mr5581451ljc.427.1596793841742;
        Fri, 07 Aug 2020 02:50:41 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1596793841; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=user-agent:in-reply-to:content-disposition:mime-version:references
         :message-id:subject:cc:to:from:date:dkim-signature;
        bh=soLm16uK596dHEye75TJmPvnsTTmXwE4pRN7A06959g=;
        b=
...
Received: from mail-wr1-x444.google.com (mail-wr1-x444.google.com. [2a00:1450:4864:20::444])
        by gmr-mx.google.com with ESMTPS id u9si184400ljg.8.2020.08.07.02.50.41
...
Received: by mail-wr1-x444.google.com with SMTP id f12so1076913wru.13
        for <kasan-dev@googlegroups.com>; Fri, 07 Aug 2020 02:50:41 -0700 (PDT)
X-Received: by 2002:adf:e60a:: with SMTP id p10mr11075352wrm.312.1596793840649;
        Fri, 07 Aug 2020 02:50:40 -0700 (PDT)
Received: from elver.google.com ([100.105.32.75])
        by smtp.gmail.com with ESMTPSA id u66sm9681330wmu.37.2020.08.07.02.50.37
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 07 Aug 2020 02:50:38 -0700 (PDT)
Date: Fri, 7 Aug 2020 11:50:32 +0200
...
Subject: Re: [PATCH] x86/paravirt: Add missing noinstr to arch_local*()
 helpers
Message-ID: <20200807095032.GA3528289@elver.google.com>
...
In-Reply-To: <fe2bfa7f-132f-7581-a967-d01d58be1588@suse.com>
User-Agent: Mutt/1.14.4 (2020-06-18)
X-Original-Sender: elver@google.com
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@google.com header.s=20161025 header.b=R28NnxXR;       spf=pass
...
> >=20
> > > With CONFIG_PARAVIRT=3Dy (without the notrace->noinstr patch), I stil=
l
> > > get lockdep DEBUG_LOCKS_WARN_ON(!lockdep_hardirqs_enabled()), althoug=
h
...
kasan-dev/20200807095032.GA3528289%40elver.google.com.
