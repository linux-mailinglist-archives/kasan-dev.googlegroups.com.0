Return-Path: <kasan-dev+bncBCX3TTWUQMPRBWEU5SKQMGQEVVAD75Q@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-lf1-x137.google.com (mail-lf1-x137.google.com [IPv6:2a00:1450:4864:20::137])
	by mail.lfdr.de (Postfix) with ESMTPS id 9569255E52C
	for <lists+kasan-dev@lfdr.de>; Tue, 28 Jun 2022 16:04:09 +0200 (CEST)
Received: by mail-lf1-x137.google.com with SMTP id bi38-20020a0565120ea600b0047f640eaee0sf6272518lfb.4
        for <lists+kasan-dev@lfdr.de>; Tue, 28 Jun 2022 07:04:09 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1656425049; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        bh=OV+ihPn/bNSB6NVhAPomwfFGtzEtsRWSt4PCo747keI=;
        b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=OV+ihPn/bNSB6NVhAPomwfFGtzEtsRWSt4PCo747keI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=OV+ihPn/bNSB6NVhAPomwfFGtzEtsRWSt4PCo747keI=;
        b=
Sender: kasan-dev@googlegroups.com
X-Gm-Message-State: AJIora+KsyemNkWB1UsOrTPtcYDtW0kZR9rH6MolkDkwB7oUwj7vMuXd
	z4lfl4K2VvzQ2P4Nf3/hoUU=
X-Google-Smtp-Source: AGRyM1ugNRBiFc0OB/RrgIoRRflB8v+ODC4lQnUlhNnXmXeFo+IOd2+chZNLllOkAiRNBqyDGuhV9A==
X-Received: by 2002:a05:6512:3ba8:b0:47f:ae21:9d60 with SMTP id g40-20020a0565123ba800b0047fae219d60mr11792308lfv.366.1656425048808;
        Tue, 28 Jun 2022 07:04:08 -0700 (PDT)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a2e:8ec4:0:b0:25a:a013:4f2b with SMTP id e4-20020a2e8ec4000000b0025aa0134f2bls1802111ljl.3.gmail;
 Tue, 28 Jun 2022 07:04:07 -0700 (PDT)
X-Received: by 2002:a05:651c:1032:b0:25a:780b:7140 with SMTP id w18-20020a05651c103200b0025a780b7140mr9989509ljm.319.1656425046905;
        Tue, 28 Jun 2022 07:04:06 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1656425046; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from;
        bh=svk0BgEL5lsceur11o5XFW7q04Ke+mIRwnEdmHbyxPc=;
        b=
ARC-Authentication-Results: i=1; gmr-mx.google.com;
       spf=pass (google.com: domain of ukl@pengutronix.de designates 2001:67c:670:201:290:27ff:fe1d:cc33 as permitted sender) smtp.mailfrom=ukl@pengutronix.de
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de. [2001:67c:670:201:290:27ff:fe1d:cc33])
        by gmr-mx.google.com with ESMTPS id i2-20020a056512340200b004793442a7f0si576929lfr.6.2022.06.28.07.04.06
...
Received: from drehscheibe.grey.stw.pengutronix.de ([2a0a:edc0:0:c01:1d::a2])
	...
	id 1o6BoJ-0008Ov-QC; Tue, 28 Jun 2022 16:03:24 +0200
Received: from [2a0a:edc0:0:900:1d::77] (helo=ptz.office.stw.pengutronix.de)
	by drehscheibe.grey.stw.pengutronix.de with esmtp (Exim 4.94.2)
	(envelope-from <ukl@pengutronix.de>)
	id 1o6BoF-003DTc-Gw; Tue, 28 Jun 2022 16:03:23 +0200
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=465666; i=u.kleine-koenig@pengutronix.de; h=from:subject; bh=7YggIytQlxlDCnbU6A56GMFZl+ZI7y487xap3O9xEX4=; b=owEBbQGS/pANAwAKAcH8FHityuwJAcsmYgBiuwoaJalTd8EeJwATIwpq0s7/fgmIz02XNMhZhojw 51X4YGWJATMEAAEKAB0WIQR+cioWkBis/z50pAvB/BR4rcrsCQUCYrsKGgAKCRDB/BR4rcrsCXmvB/ 9Zuqol/3ZJDMSB8xX/fGjZFwz6GqbyavSPcgSSQhFpRFVxzOV0HABIELEy5fHovq9Y9OqAmadv+Wlv Hv+bpU7RFYWYuWXaHUi2B6sZo61s+WdO8hLTQkvwjb8JOOxm44ebMJz31gO8fwyn8+FMj75bKb3GMX FhRLQDo4FZppwBh6K150k/J9TiZ+mvGHaHHk6qRPLzC93oORgb3D5+EAlXCd9wxjPwTSYhwwoo+DdJ J4DHkDrC9hcz+XsZdtlWFl+1/zlAcJqrJGCl1oWr7lB75eBAynZ23CmOw9C2iO68a9PeDcsox7UpRS 5E+ZGRw9sIH5Wo8hFmRr4nc9KBIuOg
...
diff --git a/Documentation/i2c/writing-clients.rst b/Documentation/i2c/writ=
ing-clients.rst
...
@@ -554,10 +554,9 @@ static int dm6446evm_msp_probe(struct i2c_client *clie=
nt)
 	return 0;
 }
=20
...
diff --git a/arch/powerpc/platforms/83xx/mcu_mpc8349emitx.c b/arch/powerpc/=
platforms/83xx/mcu_mpc8349emitx.c
...
@@ -264,13 +264,11 @@ static int st33zp24_i2c_probe(struct i2c_client *clie=
nt,
...
diff --git a/drivers/char/tpm/tpm_i2c_infineon.c b/drivers/char/tpm/tpm_i2c=
_infineon.c
index a19d32cb4e94..fd3c3661e646 100644
--- a/drivers/char/tpm/tpm_i2c_infineon.c
+++ b/drivers/char/tpm/tpm_i2c_infineon.c
@@ -706,15 +706,13 @@ static int tpm_tis_i2c_probe(struct i2c_client *clien=
t,
 	return rc;
 }
=20
...
@@ -622,12 +622,11 @@ static int i2c_nuvoton_probe(struct i2c_client *clien=
t,
 	return tpm_chip_register(chip);
 }
=20
...
@@ -763,20 +763,18 @@ static int tpm_cr50_i2c_probe(struct i2c_client *clie=
nt)
  * - 0:		Success.
...
@@ -557,7 +557,7 @@ static int cs2000_version_print(struct cs2000_priv *pri=
v)
 	return 0;
 }
=20
...
@@ -1651,11 +1651,9 @@ static int si5351_i2c_probe(struct i2c_client *clien=
t)
 	return 0;
 }
=20
...
=20
 #ifdef CONFIG_OF
diff --git a/drivers/crypto/atmel-sha204a.c b/drivers/crypto/atmel-sha204a.=
c
index e4087bdd2475..a84b657598c6 100644
--- a/drivers/crypto/atmel-sha204a.c
+++ b/drivers/crypto/atmel-sha204a.c
@@ -116,18 +116,16 @@ static int atmel_sha204a_probe(struct i2c_client *cli=
ent,
 	return ret;
 }
=20
...
diff --git a/drivers/extcon/extcon-rt8973a.c b/drivers/extcon/extcon-rt8973=
a.c
...
@@ -411,14 +411,12 @@ static int adp5588_gpio_probe(struct i2c_client *clie=
nt)
 	return 0;
 }
=20
...
@@ -1335,7 +1335,7 @@ static int adv7511_probe(struct i2c_client *i2c, cons=
...
@@ -1357,7 +1357,7 @@ static int anx78xx_i2c_probe(struct i2c_client *clien=
t,
 	return err;
 }
=20
...
=20
@@ -1366,8 +1366,6 @@ static int anx78xx_i2c_remove(struct i2c_client *clie=
nt)
...
@@ -2733,7 +2733,7 @@ static int anx7625_i2c_probe(struct i2c_client *clien=
t,
 	return ret;
 }
=20
...
=20
@@ -2755,8 +2755,6 @@ static int anx7625_i2c_remove(struct i2c_client *clie=
nt)
=20
...
diff --git a/drivers/gpu/drm/bridge/chrontel-ch7033.c b/drivers/gpu/drm/bri=
dge/chrontel-ch7033.c
...
diff --git a/drivers/gpu/drm/bridge/cros-ec-anx7688.c b/drivers/gpu/drm/bri=
dge/cros-ec-anx7688.c
index 0f6d907432e3..fa91bdeddef0 100644
--- a/drivers/gpu/drm/bridge/cros-ec-anx7688.c
+++ b/drivers/gpu/drm/bridge/cros-ec-anx7688.c
@@ -159,13 +159,11 @@ static int cros_ec_anx7688_bridge_probe(struct i2c_cl=
ient *client)
 	return 0;
 }
=20
...
=20
 static const struct of_device_id cros_ec_anx7688_bridge_match_table[] =3D =
{
diff --git a/drivers/gpu/drm/bridge/ite-it6505.c b/drivers/gpu/drm/bridge/i=
te-it6505.c
...
=20
@@ -3324,8 +3324,6 @@ static int it6505_i2c_remove(struct i2c_client *clien=
t)
...
diff --git a/drivers/gpu/drm/bridge/ite-it66121.c b/drivers/gpu/drm/bridge/=
ite-it66121.c
...
diff --git a/drivers/gpu/drm/bridge/lontium-lt8912b.c b/drivers/gpu/drm/bri=
dge/lontium-lt8912b.c
...
diff --git a/drivers/gpu/drm/bridge/lontium-lt9611uxc.c b/drivers/gpu/drm/b=
ridge/lontium-lt9611uxc.c
...
@@ -355,11 +355,9 @@ static int stdp4028_ge_b850v3_fw_probe(struct i2c_clie=
nt *stdp4028_i2c,
...
@@ -405,11 +403,9 @@ static int stdp2690_ge_b850v3_fw_probe(struct i2c_clie=
nt *stdp2690_i2c,
 	return ge_b850v3_register();
 }
=20
...
@@ -2148,13 +2148,11 @@ static int tc_probe(struct i2c_client *client, cons=
t struct i2c_device_id *id)
 	return 0;
 }
=20
...
diff --git a/drivers/gpu/drm/bridge/tc358768.c b/drivers/gpu/drm/bridge/tc3=
58768.c
index fd585bf925fe..4c4b77ce8aba 100644
--- a/drivers/gpu/drm/bridge/tc358768.c
+++ b/drivers/gpu/drm/bridge/tc358768.c
@@ -1072,13 +1072,11 @@ static int tc358768_i2c_probe(struct i2c_client *cl=
ient,
...
@@ -713,13 +713,11 @@ static int tc_probe(struct i2c_client *client, const =
...
@@ -417,11 +417,9 @@ static int ch7006_probe(struct i2c_client *client, con=
st struct i2c_device_id *i
 	return -ENODEV;
 }
=20
...
@@ -2075,11 +2075,10 @@ tda998x_probe(struct i2c_client *client, const stru=
ct i2c_device_id *id)
 	return ret;
 }
=20
...
=20
 #ifdef CONFIG_OF
diff --git a/drivers/gpu/drm/panel/panel-olimex-lcd-olinuxino.c b/drivers/g=
pu/drm/panel/panel-olimex-lcd-olinuxino.c
index cb5cb27462df..36a46cb7fe1c 100644
--- a/drivers/gpu/drm/panel/panel-olimex-lcd-olinuxino.c
+++ b/drivers/gpu/drm/panel/panel-olimex-lcd-olinuxino.c
@@ -288,7 +288,7 @@ static int lcd_olinuxino_probe(struct i2c_client *clien=
t,
 	return 0;
 }
=20
...
=20
@@ -296,8 +296,6 @@ static int lcd_olinuxino_remove(struct i2c_client *clie=
nt)
=20
...
=20
@@ -454,8 +454,6 @@ static int rpi_touchscreen_remove(struct i2c_client *i2=
c)
...
diff --git a/drivers/gpu/drm/solomon/ssd130x-i2c.c b/drivers/gpu/drm/solomo=
n/ssd130x-i2c.c
...
@@ -1064,7 +1064,7 @@ int i2c_hid_core_probe(struct i2c_client *client, str=
uct i2chid_ops *ops,
 }
...
@@ -208,7 +208,7 @@ static void asb100_write_value(struct i2c_client *clien=
t, u16 reg, u16 val);
...
@@ -2508,14 +2508,12 @@ static int dme1737_i2c_probe(struct i2c_client *cli=
ent)
 	return err;
 }
=20
...
@@ -285,7 +285,7 @@ static int w83793_write_value(struct i2c_client *client=
, u16 reg, u8 value);
...
@@ -65,7 +65,7 @@ static const unsigned short normal_i2c[] =3D { 0x2e, I2C_=
CLIENT_END };
...
+static void w83l785ts_remove(struct i2c_client *client);
 static u8 w83l785ts_read_value(struct i2c_client *client, u8 reg, u8 defva=
l);
...
diff --git a/drivers/i2c/i2c-slave-eeprom.c b/drivers/i2c/i2c-slave-eeprom.=
c
...
diff --git a/drivers/i2c/i2c-slave-testunit.c b/drivers/i2c/i2c-slave-testu=
nit.c
index 56dae08dfd48..75ee7ebdb614 100644
--- a/drivers/i2c/i2c-slave-testunit.c
+++ b/drivers/i2c/i2c-slave-testunit.c
@@ -153,13 +153,12 @@ static int i2c_slave_testunit_probe(struct i2c_client=
 *client)
...
diff --git a/drivers/i2c/muxes/i2c-mux-ltc4306.c b/drivers/i2c/muxes/i2c-mu=
x-ltc4306.c
...
diff --git a/drivers/iio/accel/bma400_i2c.c b/drivers/iio/accel/bma400_i2c.=
c
...
diff --git a/drivers/iio/accel/bmc150-accel-i2c.c b/drivers/iio/accel/bmc15=
0-accel-i2c.c
index dff4d7dd101c..be8cc598b88e 100644
--- a/drivers/iio/accel/bmc150-accel-i2c.c
+++ b/drivers/iio/accel/bmc150-accel-i2c.c
@@ -209,13 +209,11 @@ static int bmc150_accel_probe(struct i2c_client *clie=
nt,
 	return 0;
 }
=20
...
diff --git a/drivers/iio/accel/mma7455_i2c.c b/drivers/iio/accel/mma7455_i2=
c.c
...
@@ -218,8 +218,6 @@ static int mma7660_remove(struct i2c_client *client)
 	if (ret)
 		dev_warn(&client->dev, "Failed to put device in stand-by mode (%pe), ign=
oring\n",
 			 ERR_PTR(ret));
-
-	return 0;
...
=20
 #ifdef CONFIG_PM
diff --git a/drivers/iio/chemical/atlas-sensor.c b/drivers/iio/chemical/atl=
as-sensor.c
...
diff --git a/drivers/iio/gyro/fxas21002c_i2c.c b/drivers/iio/gyro/fxas21002=
c_i2c.c
...
diff --git a/drivers/iio/gyro/itg3200_core.c b/drivers/iio/gyro/itg3200_cor=
e.c
...
diff --git a/drivers/iio/gyro/mpu3050-i2c.c b/drivers/iio/gyro/mpu3050-i2c.=
c
...
diff --git a/drivers/iio/humidity/hdc2010.c b/drivers/iio/humidity/hdc2010.=
c
...
diff --git a/drivers/iio/light/gp2ap020a00f.c b/drivers/iio/light/gp2ap020a=
00f.c
index b820041159f7..826439299e8b 100644
--- a/drivers/iio/light/gp2ap020a00f.c
+++ b/drivers/iio/light/gp2ap020a00f.c
@@ -1573,7 +1573,7 @@ static int gp2ap020a00f_probe(struct i2c_client *clie=
nt,
 	return err;
 }
=20
...
@@ -1589,8 +1589,6 @@ static int gp2ap020a00f_remove(struct i2c_client *cli=
ent)
 	free_irq(client->irq, indio_dev);
...
@@ -300,15 +300,13 @@ static int isl29125_powerdown(struct isl29125_data *d=
ata)
...
diff --git a/drivers/iio/light/pa12203001.c b/drivers/iio/light/pa12203001.=
c
...
@@ -207,12 +207,10 @@ static int tsl4531_powerdown(struct i2c_client *clien=
t)
...
diff --git a/drivers/iio/magnetometer/ak8974.c b/drivers/iio/magnetometer/a=
k8974.c
...
diff --git a/drivers/iio/magnetometer/ak8975.c b/drivers/iio/magnetometer/a=
k8975.c
...
@@ -34,11 +34,9 @@ static int bmc150_magn_i2c_probe(struct i2c_client *clie=
nt,
...
diff --git a/drivers/iio/magnetometer/hmc5843_i2c.c b/drivers/iio/magnetome=
ter/hmc5843_i2c.c
...
diff --git a/drivers/iio/magnetometer/yamaha-yas530.c b/drivers/iio/magneto=
meter/yamaha-yas530.c
...
diff --git a/drivers/iio/potentiostat/lmp91000.c b/drivers/iio/potentiostat=
/lmp91000.c
...
diff --git a/drivers/iio/pressure/mpl3115.c b/drivers/iio/pressure/mpl3115.=
c
...
diff --git a/drivers/iio/pressure/ms5611_i2c.c b/drivers/iio/pressure/ms561=
1_i2c.c
...
diff --git a/drivers/iio/pressure/zpa2326_i2c.c b/drivers/iio/pressure/zpa2=
326_i2c.c
...
diff --git a/drivers/iio/proximity/pulsedlight-lidar-lite-v2.c b/drivers/ii=
o/proximity/pulsedlight-lidar-lite-v2.c
...
diff --git a/drivers/iio/proximity/sx9500.c b/drivers/iio/proximity/sx9500.=
c
...
diff --git a/drivers/iio/temperature/mlx90614.c b/drivers/iio/temperature/m=
lx90614.c
...
diff --git a/drivers/input/joystick/as5011.c b/drivers/input/joystick/as501=
1.c
...
=20
 #ifdef CONFIG_PM
diff --git a/drivers/input/keyboard/lm8323.c b/drivers/input/keyboard/lm832=
3.c
...
=20
 #ifdef CONFIG_PM_SLEEP
diff --git a/drivers/input/keyboard/lm8333.c b/drivers/input/keyboard/lm833=
3.c
...
diff --git a/drivers/input/keyboard/mcs_touchkey.c b/drivers/input/keyboard=
/mcs_touchkey.c
...
=20
@@ -203,8 +203,6 @@ static int mcs_touchkey_remove(struct i2c_client *clien=
t)
 		data->poweron(false);
...
diff --git a/drivers/input/keyboard/qt1070.c b/drivers/input/keyboard/qt107=
0.c
...
=20
 #ifdef CONFIG_PM_SLEEP
diff --git a/drivers/input/keyboard/qt2160.c b/drivers/input/keyboard/qt216=
0.c
...
diff --git a/drivers/input/keyboard/tca6416-keypad.c b/drivers/input/keyboa=
rd/tca6416-keypad.c
index 2a9755910065..afcdfbb002ff 100644
--- a/drivers/input/keyboard/tca6416-keypad.c
+++ b/drivers/input/keyboard/tca6416-keypad.c
@@ -307,7 +307,7 @@ static int tca6416_keypad_probe(struct i2c_client *clie=
nt,
 	return error;
 }
=20
...
=20
@@ -318,8 +318,6 @@ static int tca6416_keypad_remove(struct i2c_client *cli=
ent)
=20
...
diff --git a/drivers/input/misc/cma3000_d0x_i2c.c b/drivers/input/misc/cma3=
000_d0x_i2c.c
...
=20
 #ifdef CONFIG_PM
diff --git a/drivers/input/misc/pcf8574_keypad.c b/drivers/input/misc/pcf85=
74_keypad.c
...
=20
 #ifdef CONFIG_PM
diff --git a/drivers/input/mouse/synaptics_i2c.c b/drivers/input/mouse/syna=
ptics_i2c.c
index fa304648d611..987ee67a1045 100644
--- a/drivers/input/mouse/synaptics_i2c.c
+++ b/drivers/input/mouse/synaptics_i2c.c
@@ -587,7 +587,7 @@ static int synaptics_i2c_probe(struct i2c_client *clien=
t,
 	return ret;
 }
=20
...
=20
@@ -596,8 +596,6 @@ static int synaptics_i2c_remove(struct i2c_client *clie=
nt)
=20
...
diff --git a/drivers/input/rmi4/rmi_smbus.c b/drivers/input/rmi4/rmi_smbus.=
c
...
diff --git a/drivers/input/touchscreen/atmel_mxt_ts.c b/drivers/input/touch=
screen/atmel_mxt_ts.c
index eb66cd2689b7..4eedea08b0b5 100644
--- a/drivers/input/touchscreen/atmel_mxt_ts.c
+++ b/drivers/input/touchscreen/atmel_mxt_ts.c
@@ -3284,7 +3284,7 @@ static int mxt_probe(struct i2c_client *client, const=
 struct i2c_device_id *id)
 	return error;
 }
=20
...
diff --git a/drivers/input/touchscreen/bu21013_ts.c b/drivers/input/touchsc=
reen/bu21013_ts.c
...
diff --git a/drivers/input/touchscreen/cyttsp4_i2c.c b/drivers/input/touchs=
creen/cyttsp4_i2c.c
...
diff --git a/drivers/input/touchscreen/edt-ft5x06.c b/drivers/input/touchsc=
reen/edt-ft5x06.c
index bb2e1cbffba7..0c325132a955 100644
--- a/drivers/input/touchscreen/edt-ft5x06.c
+++ b/drivers/input/touchscreen/edt-ft5x06.c
@@ -1266,13 +1266,11 @@ static int edt_ft5x06_ts_probe(struct i2c_client *c=
lient,
 	return 0;
 }
=20
...
@@ -1383,14 +1383,12 @@ static int goodix_ts_probe(struct i2c_client *clien=
t,
 	return 0;
 }
=20
...
diff --git a/drivers/input/touchscreen/migor_ts.c b/drivers/input/touchscre=
en/migor_ts.c
...
diff --git a/drivers/input/touchscreen/tsc2004.c b/drivers/input/touchscree=
n/tsc2004.c
...
diff --git a/drivers/leds/flash/leds-as3645a.c b/drivers/leds/flash/leds-as=
3645a.c
...
diff --git a/drivers/leds/flash/leds-lm3601x.c b/drivers/leds/flash/leds-lm=
3601x.c
...
diff --git a/drivers/leds/flash/leds-rt4505.c b/drivers/leds/flash/leds-rt4=
505.c
...
diff --git a/drivers/leds/leds-is31fl319x.c b/drivers/leds/leds-is31fl319x.=
c
...
=20
 /*
diff --git a/drivers/leds/leds-is31fl32xx.c b/drivers/leds/leds-is31fl32xx.=
c
...
diff --git a/drivers/macintosh/ams/ams-i2c.c b/drivers/macintosh/ams/ams-i2=
c.c
...
diff --git a/drivers/macintosh/therm_adt746x.c b/drivers/macintosh/therm_ad=
t746x.c
...
diff --git a/drivers/macintosh/therm_windtunnel.c b/drivers/macintosh/therm=
_windtunnel.c
...
=20
 static int
diff --git a/drivers/macintosh/windfarm_ad7417_sensor.c b/drivers/macintosh=
...
diff --git a/drivers/macintosh/windfarm_fcu_controls.c b/drivers/macintosh/=
...
diff --git a/drivers/macintosh/windfarm_lm75_sensor.c b/drivers/macintosh/w=
indfarm_lm75_sensor.c
...
diff --git a/drivers/macintosh/windfarm_lm87_sensor.c b/drivers/macintosh/w=
indfarm_lm87_sensor.c
...
diff --git a/drivers/macintosh/windfarm_max6690_sensor.c b/drivers/macintos=
h/windfarm_max6690_sensor.c
...
diff --git a/drivers/macintosh/windfarm_smu_sat.c b/drivers/macintosh/windf=
arm_smu_sat.c
...
diff --git a/drivers/media/cec/i2c/ch7322.c b/drivers/media/cec/i2c/ch7322.=
c
...
@@ -899,14 +899,13 @@ dvb_pll_probe(struct i2c_client *client, const struct=
 i2c_device_id *id)
 	return 0;
 }
=20
...
@@ -974,15 +974,13 @@ static const struct dvb_frontend_ops lgdt3303_ops =3D=
 {
...
@@ -1174,7 +1174,7 @@ static int ad9389b_probe(struct i2c_client *client, c=
...
@@ -1923,7 +1923,7 @@ static int adv7511_probe(struct i2c_client *client, c=
onst struct i2c_device_id *
=20
 /* -----------------------------------------------------------------------=
 */
...
diff --git a/drivers/media/i2c/dw9807-vcm.c b/drivers/media/i2c/dw9807-vcm.=
c
...
@@ -1477,8 +1477,6 @@ static int __exit et8ek8_remove(struct i2c_client *cl=
ient)
...
diff --git a/drivers/media/i2c/ir-kbd-i2c.c b/drivers/media/i2c/ir-kbd-i2c.=
c
index 56674173524f..ee6bbbb977f7 100644
--- a/drivers/media/i2c/ir-kbd-i2c.c
+++ b/drivers/media/i2c/ir-kbd-i2c.c
@@ -915,7 +915,7 @@ static int ir_probe(struct i2c_client *client, const st=
...
@@ -675,14 +675,13 @@ static int ks0127_probe(struct i2c_client *client, co=
nst struct i2c_device_id *i
 	return 0;
 }
=20
...
=20
 /* -----------------------------------------------------------------------=
 */
diff --git a/drivers/media/i2c/m5mols/m5mols_core.c b/drivers/media/i2c/m5m=
ols/m5mols_core.c
...
@@ -859,7 +859,7 @@ static int msp_probe(struct i2c_client *client, const s=
...
diff --git a/drivers/media/i2c/noon010pc30.c b/drivers/media/i2c/noon010pc3=
0.c
...
@@ -1415,7 +1415,7 @@ static int ov08d10_get_hwcfg(struct ov08d10 *ov08d10,=
 struct device *dev)
 	return ret;
 }
=20
...
@@ -2440,7 +2440,7 @@ static int ov8856_get_hwcfg(struct ov8856 *ov8856, st=
ruct device *dev)
 	return ret;
 }
=20
...
diff --git a/drivers/media/i2c/rj54n1cb0c.c b/drivers/media/i2c/rj54n1cb0c.=
c
...
@@ -357,13 +357,11 @@ static int sony_btf_mpx_probe(struct i2c_client *clie=
nt,
 	return 0;
 }
=20
...
diff --git a/drivers/media/i2c/st-mipid02.c b/drivers/media/i2c/st-mipid02.=
c
...
@@ -177,14 +177,13 @@ static int tlv320aic23b_probe(struct i2c_client *clie=
nt,
 	return 0;
 }
=20
...
@@ -2065,7 +2065,7 @@ static int tvaudio_probe(struct i2c_client *client, c=
onst struct i2c_device_id *
 	return 0;
 }
=20
...
@@ -1121,7 +1121,7 @@ tvp514x_probe(struct i2c_client *client, const struct=
 i2c_device_id *id)
...
diff --git a/drivers/media/radio/saa7706h.c b/drivers/media/radio/saa7706h.=
c
...
@@ -438,13 +438,11 @@ static int vidtv_demod_i2c_probe(struct i2c_client *c=
lient,
 	return 0;
 }
=20
...
@@ -414,13 +414,11 @@ static int vidtv_tuner_i2c_probe(struct i2c_client *c=
lient,
 	return 0;
 }
=20
...
@@ -232,14 +232,13 @@ qm1d1b0004_probe(struct i2c_client *client, const str=
...
diff --git a/drivers/media/tuners/tua9001.c b/drivers/media/tuners/tua9001.=
c
...
@@ -81,7 +81,7 @@ static int intel_soc_pmic_i2c_probe(struct i2c_client *i2=
c,
 	return ret;
 }
=20
...
=20
@@ -91,8 +91,6 @@ static int intel_soc_pmic_i2c_remove(struct i2c_client *i=
2c)
...
@@ -199,13 +199,12 @@ static int lp8788_probe(struct i2c_client *cl, const =
struct i2c_device_id *id)
...
@@ -287,7 +287,7 @@ static int retu_probe(struct i2c_client *i2c, const str=
uct i2c_device_id *id)
 	return 0;
 }
=20
...
@@ -91,13 +91,11 @@ stmpe_i2c_probe(struct i2c_client *i2c, const struct i2=
c_device_id *id)
...
@@ -501,7 +501,7 @@ static int tps65010_gpio_get(struct gpio_chip *chip, un=
signed offset)
=20
...
=20
@@ -587,7 +587,6 @@ static int tps6586x_i2c_remove(struct i2c_client *clien=
t)
...
diff --git a/drivers/misc/ad525x_dpot-i2c.c b/drivers/misc/ad525x_dpot-i2c.=
c
...
diff --git a/drivers/misc/eeprom/idt_89hpesx.c b/drivers/misc/eeprom/idt_89=
hpesx.c
index b0cff4b152da..0c23e909bc3e 100644
--- a/drivers/misc/eeprom/idt_89hpesx.c
+++ b/drivers/misc/eeprom/idt_89hpesx.c
@@ -1401,7 +1401,7 @@ static int idt_probe(struct i2c_client *client, const=
 struct i2c_device_id *id)
 /*
...
diff --git a/drivers/misc/lis3lv02d/lis3lv02d_i2c.c b/drivers/misc/lis3lv02=
d/lis3lv02d_i2c.c
index 52555d2e824b..d7daa01fe7ca 100644
--- a/drivers/misc/lis3lv02d/lis3lv02d_i2c.c
+++ b/drivers/misc/lis3lv02d/lis3lv02d_i2c.c
@@ -177,7 +177,7 @@ static int lis3lv02d_i2c_probe(struct i2c_client *clien=
t,
 	return ret;
 }
=20
...
@@ -190,7 +190,6 @@ static int lis3lv02d_i2c_remove(struct i2c_client *clie=
nt)
=20
...
@@ -195,7 +195,7 @@ static void pismo_add_one(struct pismo_data *pismo, int=
 i,
 	}
 }
=20
...
diff --git a/drivers/net/dsa/microchip/ksz9477_i2c.c b/drivers/net/dsa/micr=
ochip/ksz9477_i2c.c
...
diff --git a/drivers/net/ethernet/mellanox/mlxsw/i2c.c b/drivers/net/ethern=
et/mellanox/mlxsw/i2c.c
...
@@ -336,14 +336,12 @@ static int fdp_nci_i2c_probe(struct i2c_client *clien=
t)
 	return 0;
 }
=20
...
@@ -268,15 +268,13 @@ static int microread_i2c_probe(struct i2c_client *cli=
ent,
 	return r;
 }
=20
...
@@ -231,13 +231,11 @@ static int nfcmrvl_i2c_probe(struct i2c_client *clien=
t,
 	return 0;
 }
=20
...
@@ -307,14 +307,12 @@ static int nxp_nci_i2c_probe(struct i2c_client *clien=
t,
 	return r;
 }
=20
...
@@ -928,7 +928,7 @@ static int pn544_hci_i2c_probe(struct i2c_client *clien=
t,
 	return 0;
 }
=20
...
=20
@@ -940,8 +940,6 @@ static int pn544_hci_i2c_remove(struct i2c_client *clie=
nt)
=20
 	if (phy->powered)
...
@@ -246,14 +246,12 @@ static int s3fwrn5_i2c_probe(struct i2c_client *clien=
t,
 	return ret;
 }
=20
...
@@ -562,7 +562,7 @@ static int st21nfca_hci_i2c_probe(struct i2c_client *cl=
ient,
 	return r;
 }
=20
...
=20
@@ -571,8 +571,6 @@ static int st21nfca_hci_i2c_remove(struct i2c_client *c=
lient)
 	if (phy->powered)
...
@@ -2525,13 +2525,12 @@ static int unittest_i2c_dev_probe(struct i2c_client=
 *client,
 	return 0;
 };
=20
...
+static void unittest_i2c_mux_remove(struct i2c_client *client)
 {
 	struct device *dev =3D &client->dev;
 	struct device_node *np =3D client->dev.of_node;
@@ -2610,7 +2609,6 @@ static int unittest_i2c_mux_remove(struct i2c_client =
*client)
=20
 	dev_dbg(dev, "%s for node @%pOF\n", __func__, np);
 	i2c_mux_del_adapters(muxc);
...
@@ -317,13 +317,11 @@ static int cros_ec_i2c_probe(struct i2c_client *clien=
t,
 	return 0;
 }
=20
...
=20
 #ifdef CONFIG_PM_SLEEP
diff --git a/drivers/platform/surface/surface3_power.c b/drivers/platform/s=
urface/surface3_power.c
...
@@ -878,14 +878,12 @@ static int tf103c_dock_probe(struct i2c_client *clien=
t)
 	return 0;
 }
=20
...
@@ -178,15 +178,13 @@ static int skl_int3472_tps68470_probe(struct i2c_clie=
nt *client)
 	return ret;
 }
=20
...
diff --git a/drivers/power/supply/bq2415x_charger.c b/drivers/power/supply/=
bq2415x_charger.c
...
diff --git a/drivers/power/supply/bq24257_charger.c b/drivers/power/supply/=
bq24257_charger.c
...
=20
 #ifdef CONFIG_PM_SLEEP
diff --git a/drivers/power/supply/bq25890_charger.c b/drivers/power/supply/=
bq25890_charger.c
...
diff --git a/drivers/power/supply/bq27xxx_battery_i2c.c b/drivers/power/sup=
ply/bq27xxx_battery_i2c.c
index cf38cbfe13e9..94b00bb89c17 100644
--- a/drivers/power/supply/bq27xxx_battery_i2c.c
+++ b/drivers/power/supply/bq27xxx_battery_i2c.c
@@ -205,7 +205,7 @@ static int bq27xxx_battery_i2c_probe(struct i2c_client =
*client,
 	return ret;
 }
=20
...
=20
@@ -214,8 +214,6 @@ static int bq27xxx_battery_i2c_remove(struct i2c_client=
 *client)
...
diff --git a/drivers/power/supply/cw2015_battery.c b/drivers/power/supply/c=
w2015_battery.c
index 728e2a6cc9c3..81e17ad80163 100644
--- a/drivers/power/supply/cw2015_battery.c
+++ b/drivers/power/supply/cw2015_battery.c
@@ -725,13 +725,12 @@ static int __maybe_unused cw_bat_resume(struct device=
 *dev)
=20
...
diff --git a/drivers/power/supply/ds2782_battery.c b/drivers/power/supply/d=
s2782_battery.c
index 9ae273fde7a2..d78cd05402f6 100644
--- a/drivers/power/supply/ds2782_battery.c
+++ b/drivers/power/supply/ds2782_battery.c
@@ -312,7 +312,7 @@ static void ds278x_power_supply_init(struct power_suppl=
y_desc *battery)
...
+static void ds278x_battery_remove(struct i2c_client *client)
 {
 	...
 	int id =3D info->id;
@@ -325,8 +325,6 @@ static int ds278x_battery_remove(struct i2c_client *cli=
ent)
...
=20
 #ifdef CONFIG_PM_SLEEP
diff --git a/drivers/power/supply/lp8727_charger.c b/drivers/power/supply/l=
p8727_charger.c
index 9ee54e397754..384a374b52c1 100644
--- a/drivers/power/supply/lp8727_charger.c
+++ b/drivers/power/supply/lp8727_charger.c
@@ -590,13 +590,12 @@ static int lp8727_probe(struct i2c_client *cl, const =
struct i2c_device_id *id)
 	return 0;
 }
=20
...
diff --git a/drivers/power/supply/rt5033_battery.c b/drivers/power/supply/r=
t5033_battery.c
index 7a23c70f4879..736dec608ff6 100644
--- a/drivers/power/supply/rt5033_battery.c
+++ b/drivers/power/supply/rt5033_battery.c
@@ -149,13 +149,11 @@ static int rt5033_battery_probe(struct i2c_client *cl=
ient,
 	return 0;
 }
=20
...
diff --git a/drivers/power/supply/rt9455_charger.c b/drivers/power/supply/r=
t9455_charger.c
...
diff --git a/drivers/power/supply/smb347-charger.c b/drivers/power/supply/s=
mb347-charger.c
...
diff --git a/drivers/power/supply/z2_battery.c b/drivers/power/supply/z2_ba=
ttery.c
...
diff --git a/drivers/regulator/da9121-regulator.c b/drivers/regulator/da912=
1-regulator.c
...
@@ -472,12 +472,11 @@ static int isl12026_probe_new(struct i2c_client *clie=
nt)
...
diff --git a/drivers/staging/media/atomisp/i2c/atomisp-gc0310.c b/drivers/s=
taging/media/atomisp/i2c/atomisp-gc0310.c
...
diff --git a/drivers/staging/media/atomisp/i2c/atomisp-lm3554.c b/drivers/s=
taging/media/atomisp/i2c/atomisp-lm3554.c
...
diff --git a/drivers/staging/media/atomisp/i2c/atomisp-mt9m114.c b/drivers/=
staging/media/atomisp/i2c/atomisp-mt9m114.c
...
diff --git a/drivers/staging/media/atomisp/i2c/atomisp-ov2680.c b/drivers/s=
taging/media/atomisp/i2c/atomisp-ov2680.c
...
diff --git a/drivers/staging/media/atomisp/i2c/atomisp-ov2722.c b/drivers/s=
taging/media/atomisp/i2c/atomisp-ov2722.c
...
diff --git a/drivers/staging/media/atomisp/i2c/ov5693/atomisp-ov5693.c b/dr=
ivers/staging/media/atomisp/i2c/ov5693/atomisp-ov5693.c
...
diff --git a/drivers/staging/media/max96712/max96712.c b/drivers/staging/me=
dia/max96712/max96712.c
...
@@ -340,14 +340,12 @@ static int i2c_probe(struct i2c_client *client, const=
 struct i2c_device_id *id)
  *
...
diff --git a/drivers/staging/olpc_dcon/olpc_dcon.c b/drivers/staging/olpc_d=
con/olpc_dcon.c
index 7284cb4ac395..aea2841f7598 100644
--- a/drivers/staging/olpc_dcon/olpc_dcon.c
+++ b/drivers/staging/olpc_dcon/olpc_dcon.c
@@ -671,7 +671,7 @@ static int dcon_probe(struct i2c_client *client, const =
struct i2c_device_id *id)
 	return rc;
 }
=20
...
@@ -1683,11 +1683,9 @@ static int sc16is7xx_i2c_probe(struct i2c_client *i2=
c,
...
diff --git a/drivers/usb/phy/phy-isp1301-omap.c b/drivers/usb/phy/phy-isp13=
01-omap.c
...
diff --git a/drivers/usb/typec/mux/fsa4480.c b/drivers/usb/typec/mux/fsa448=
0.c
...
diff --git a/drivers/usb/typec/mux/pi3usb30532.c b/drivers/usb/typec/mux/pi=
3usb30532.c
index 6ce9f282594e..1cd388b55c30 100644
--- a/drivers/usb/typec/mux/pi3usb30532.c
+++ b/drivers/usb/typec/mux/pi3usb30532.c
@@ -160,13 +160,12 @@ static int pi3usb30532_probe(struct i2c_client *clien=
t)
 	return 0;
 }
=20
...
=20
 static const struct of_device_id __maybe_unused rt1719_device_table[] =3D =
{
...
diff --git a/drivers/usb/typec/tcpm/tcpci_maxim.c b/drivers/usb/typec/tcpm/=
tcpci_maxim.c
...
diff --git a/drivers/usb/typec/tcpm/tcpci_rt1711h.c b/drivers/usb/typec/tcp=
m/tcpci_rt1711h.c
...
diff --git a/drivers/video/backlight/adp8860_bl.c b/drivers/video/backlight=
/adp8860_bl.c
...
=20
 #ifdef CONFIG_PM_SLEEP
diff --git a/drivers/video/backlight/adp8870_bl.c b/drivers/video/backlight=
/adp8870_bl.c
...
=20
 #ifdef CONFIG_PM_SLEEP
diff --git a/drivers/video/backlight/arcxcnn_bl.c b/drivers/video/backlight=
/arcxcnn_bl.c
index 7b1c0a0e6cad..060c0eef6a52 100644
--- a/drivers/video/backlight/arcxcnn_bl.c
+++ b/drivers/video/backlight/arcxcnn_bl.c
@@ -362,7 +362,7 @@ static int arcxcnn_probe(struct i2c_client *cl, const s=
truct i2c_device_id *id)
 	return ret;
 }
=20
...
diff --git a/drivers/video/backlight/bd6107.c b/drivers/video/backlight/bd6=
107.c
...
diff --git a/drivers/video/backlight/lm3639_bl.c b/drivers/video/backlight/=
lm3639_bl.c
...
diff --git a/drivers/video/backlight/lp855x_bl.c b/drivers/video/backlight/=
lp855x_bl.c
index 2b9e2bbbb03e..43b39cf68b04 100644
--- a/drivers/video/backlight/lp855x_bl.c
+++ b/drivers/video/backlight/lp855x_bl.c
@@ -537,7 +537,7 @@ static int lp855x_probe(struct i2c_client *cl, const st=
ruct i2c_device_id *id)
 	return ret;
 }
=20
...
diff --git a/drivers/video/backlight/lv5207lp.c b/drivers/video/backlight/l=
v5207lp.c
...
diff --git a/drivers/video/backlight/tosa_bl.c b/drivers/video/backlight/to=
sa_bl.c
...
=20
 #ifdef CONFIG_PM_SLEEP
diff --git a/drivers/video/fbdev/matrox/matroxfb_maven.c b/drivers/video/fb=
dev/matrox/matroxfb_maven.c
...
diff --git a/drivers/video/fbdev/ssd1307fb.c b/drivers/video/fbdev/ssd1307f=
b.c
...
@@ -708,13 +708,11 @@ static int ziirave_wdt_probe(struct i2c_client *clien=
t,
 	return ret;
 }
=20
...
diff --git a/sound/pci/hda/cs35l41_hda_i2c.c b/sound/pci/hda/cs35l41_hda_i2=
c.c
index e810b278fb91..acab8c058e66 100644
--- a/sound/pci/hda/cs35l41_hda_i2c.c
+++ b/sound/pci/hda/cs35l41_hda_i2c.c
@@ -30,11 +30,9 @@ static int cs35l41_hda_i2c_probe(struct i2c_client *clt,=
...
@@ -71,14 +71,12 @@ static int keywest_attach_adapter(struct i2c_adapter *a=
dapter)
 	return 0;
 }
=20
...
=20
=20
diff --git a/sound/soc/codecs/adau1761-i2c.c b/sound/soc/codecs/adau1761-i2=
c.c
...
diff --git a/sound/soc/codecs/adau1781-i2c.c b/sound/soc/codecs/adau1781-i2=
c.c
...
@@ -498,14 +498,12 @@ static int cs35l32_i2c_probe(struct i2c_client *i2c_c=
lient)
 	return ret;
 }
=20
...
@@ -1251,7 +1251,7 @@ static int cs35l33_i2c_probe(struct i2c_client *i2c_c=
lient)
 	return ret;
 }
=20
...
=20
@@ -1260,8 +1260,6 @@ static int cs35l33_i2c_remove(struct i2c_client *clie=
nt)
 	pm_runtime_disable(&client->dev);
...
@@ -1129,7 +1129,7 @@ static int cs35l34_i2c_probe(struct i2c_client *i2c_c=
lient)
 	return ret;
 }
=20
...
=20
@@ -1138,8 +1138,6 @@ static int cs35l34_i2c_remove(struct i2c_client *clie=
nt)
 	pm_runtime_disable(&client->dev);
...
@@ -1628,14 +1628,12 @@ static int cs35l35_i2c_probe(struct i2c_client *i2c=
_client)
 	return ret;
 }
=20
...
@@ -1911,7 +1911,7 @@ static int cs35l36_i2c_probe(struct i2c_client *i2c_c=
lient)
 	return ret;
 }
=20
...
=20
@@ -1925,8 +1925,6 @@ static int cs35l36_i2c_remove(struct i2c_client *clie=
nt)
...
diff --git a/sound/soc/codecs/cs35l41-i2c.c b/sound/soc/codecs/cs35l41-i2c.=
c
...
=20
 #ifdef CONFIG_OF
diff --git a/sound/soc/codecs/cs35l45-i2c.c b/sound/soc/codecs/cs35l45-i2c.=
c
...
@@ -851,7 +851,7 @@ static int cs4234_i2c_probe(struct i2c_client *i2c_clie=
nt)
 	return ret;
 }
=20
...
@@ -859,8 +859,6 @@ static int cs4234_i2c_remove(struct i2c_client *i2c_cli=
ent)
...
@@ -624,14 +624,12 @@ static int cs4265_i2c_probe(struct i2c_client *i2c_cl=
ient)
...
@@ -2342,7 +2342,7 @@ static int cs42l42_i2c_probe(struct i2c_client *i2c_c=
lient)
 	return ret;
 }
=20
...
=20
@@ -2359,8 +2359,6 @@ static int cs42l42_i2c_remove(struct i2c_client *i2c_=
client)
=20
...
diff --git a/sound/soc/codecs/cs42l51-i2c.c b/sound/soc/codecs/cs42l51-i2c.=
c
...
@@ -1321,13 +1321,12 @@ static int cs42l56_i2c_probe(struct i2c_client *i2c=
_client)
 	return ret;
 }
=20
...
diff --git a/sound/soc/codecs/cs42xx8-i2c.c b/sound/soc/codecs/cs42xx8-i2c.=
c
...
@@ -2584,7 +2584,7 @@ static int cs43130_i2c_probe(struct i2c_client *clien=
t)
 	return ret;
 }
=20
...
=20
@@ -2611,8 +2611,6 @@ static int cs43130_i2c_remove(struct i2c_client *clie=
nt)
=20
 	pm_runtime_disable(&client->dev);
...
@@ -1044,7 +1044,7 @@ static int cs53l30_i2c_probe(struct i2c_client *clien=
t)
 	return ret;
 }
=20
...
=20
@@ -1053,8 +1053,6 @@ static int cs53l30_i2c_remove(struct i2c_client *clie=
nt)
=20
...
@@ -2618,11 +2618,9 @@ static void max98090_i2c_shutdown(struct i2c_client =
*i2c)
 	msleep(40);
 }
=20
...
=20
 static const struct i2c_device_id nau8825_i2c_ids[] =3D {
 	{ "nau8825", 0 },
diff --git a/sound/soc/codecs/pcm1789-i2c.c b/sound/soc/codecs/pcm1789-i2c.=
c
...
=20
 #ifdef CONFIG_OF
diff --git a/sound/soc/codecs/pcm3168a-i2c.c b/sound/soc/codecs/pcm3168a-i2=
c.c
...
diff --git a/sound/soc/codecs/pcm512x-i2c.c b/sound/soc/codecs/pcm512x-i2c.=
c
...
@@ -302,11 +302,9 @@ static void rt5682_i2c_shutdown(struct i2c_client *cli=
ent)
 	rt5682_reset(rt5682);
 }
=20
...
@@ -1791,15 +1791,13 @@ static int sgtl5000_i2c_probe(struct i2c_client *cl=
ient)
 	return ret;
 }
=20
...
@@ -885,13 +885,11 @@ static int tas571x_i2c_probe(struct i2c_client *clien=
t)
 	return ret;
 }
=20
...
diff --git a/sound/soc/codecs/tlv320adc3xxx.c b/sound/soc/codecs/tlv320adc3=
xxx.c
...
=20
@@ -1435,7 +1435,6 @@ static int __exit adc3xxx_i2c_remove(struct i2c_clien=
t *client)
...
diff --git a/sound/soc/codecs/tlv320aic32x4-i2c.c b/sound/soc/codecs/tlv320=
aic32x4-i2c.c
...
diff --git a/sound/soc/codecs/tlv320aic3x-i2c.c b/sound/soc/codecs/tlv320ai=
c3x-i2c.c
...
diff --git a/sound/soc/codecs/tlv320dac33.c b/sound/soc/codecs/tlv320dac33.=
c
...
=20
@@ -2192,8 +2192,6 @@ static int wm8903_i2c_remove(struct i2c_client *clien=
t)
 	if (client->irq)
...
=20
@@ -3076,8 +3076,6 @@ static int wm8996_i2c_remove(struct i2c_client *clien=
t)
...
kasan-dev/20220628140313.74984-7-u.kleine-koenig%40pengutronix.de.
