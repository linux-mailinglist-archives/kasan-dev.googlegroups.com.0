Return-Path: <kasan-dev+bncBC7OBJGL2MHBBEVOW3XAKGQEU64BD7I@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-lf1-x13b.google.com (mail-lf1-x13b.google.com [IPv6:2a00:1450:4864:20::13b])
	by mail.lfdr.de (Postfix) with ESMTPS id 816BCFCC7B
	for <lists+kasan-dev@lfdr.de>; Thu, 14 Nov 2019 19:04:03 +0100 (CET)
Received: by mail-lf1-x13b.google.com with SMTP id v13sf2196264lfq.2
        for <lists+kasan-dev@lfdr.de>; Thu, 14 Nov 2019 10:04:03 -0800 (PST)
ARC-Seal: i=2; a=rsa-sha256; t=1573754643; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:reply-to:cc:to:from:subject
         :references:mime-version:message-id:in-reply-to:date:dkim-signature;
        bh=0FqTELeok3jzfm6Sj0JnyVVntVFKj0noUxivGLlq3l4=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@google.com header.s=20161025 header.b=BwVJKC9B;
       spf=pass (google.com: domain of 3ejfnxqukcwklsclynvvnsl.jvtrhzhu-klcnvvnslnyvbwz.jvt@flex--elver.bounces.google.com designates 2a00:1450:4864:20::44a as permitted sender) smtp.mailfrom=3EJfNXQUKCWkLScLYNVVNSL.JVTRHZHU-KLcNVVNSLNYVbWZ.JVT@flex--elver.bounces.google.com;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=0FqTELeok3jzfm6Sj0JnyVVntVFKj0noUxivGLlq3l4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:date:in-reply-to:message-id:mime-version
         ...
         :list-subscribe:list-unsubscribe;
        bh=0FqTELeok3jzfm6Sj0JnyVVntVFKj0noUxivGLlq3l4=;
        b=
X-Gm-Message-State: APjAAAWuWEFrY2njNkiAxk60dm3URbRe59Sv4CUZ0m/zHFx1sarN2i9Q
	uMRxw4Q3vrJx/P1bD8/rXbE=
X-Google-Smtp-Source: APXvYqwRTXDNkmBEUtDgoZ2zr0ly+hVPBmZA6gP3C9Wv5l5swJUcSMUf/fnV3471zfSL2zSQCxuAxw==
X-Received: by 2002:a2e:2903:: with SMTP id u3mr7660296lje.131.1573754642747;
        Thu, 14 Nov 2019 10:04:02 -0800 (PST)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:ac2:5c07:: with SMTP id r7ls1043117lfp.2.gmail; Thu, 14 Nov
 2019 10:04:01 -0800 (PST)
X-Received: by 2002:a19:820e:: with SMTP id e14mr7626818lfd.29.1573754641706;
        Thu, 14 Nov 2019 10:04:01 -0800 (PST)
ARC-Seal: i=1; a=rsa-sha256; t=1573754641; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=cc:to:from:subject:references:mime-version:message-id:in-reply-to
         :date:dkim-signature;
        bh=ySFA0MJ6HpQmTqHh+HU8xx23lv+0eAQVWHBIC7GHDgE=;
        b=
...
Received: from mail-wr1-x44a.google.com (mail-wr1-x44a.google.com. [2a00:1450:4864:20::44a])
        by gmr-mx.google.com with ESMTPS id x23si385218lfq.0.2019.11.14.10.04.01
        for <kasan-dev@googlegroups.com>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 14 Nov 2019 10:04:01 -0800 (PST)
Received-SPF: pass (google.com: domain of 3ejfnxqukcwklsclynvvnsl.jvtrhzhu-klcnvvnslnyvbwz.jvt@flex--elver.bounces.google.com designates 2a00:1450:4864:20::44a as permitted sender) client-ip=2a00:1450:4864:20::44a;
Received: by mail-wr1-x44a.google.com with SMTP id q6so4893566wrv.11
        for <kasan-dev@googlegroups.com>; Thu, 14 Nov 2019 10:04:01 -0800 (PST)
X-Received: by 2002:adf:b746:: with SMTP id n6mr9273821wre.65.1573754640261;
 Thu, 14 Nov 2019 10:04:00 -0800 (PST)
Date: Thu, 14 Nov 2019 19:02:54 +0100
In-Reply-To: <20191114180303.66955-1-elver@google.com>
Message-Id: <20191114180303.66955-2-elver@google.com>
Mime-Version: 1.0
References: <20191114180303.66955-1-elver@google.com>
X-Mailer: git-send-email 2.24.0.rc1.363.gb1bccd3e3d-goog
Subject: [PATCH v4 01/10] kcsan: Add Kernel Concurrency Sanitizer infrastructure
...
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@google.com header.s=20161025 header.b=BwVJKC9B;       spf=pass
 (google.com: domain of 3ejfnxqukcwklsclynvvnsl.jvtrhzhu-klcnvvnslnyvbwz.jvt@flex--elver.bounces.google.com
 designates 2a00:1450:4864:20::44a as permitted sender) smtp.mailfrom=3EJfNXQUKCWkLScLYNVVNSL.JVTRHZHU-KLcNVVNSLNYVbWZ.JVT@flex--elver.bounces.google.com;
       dmarc=pass (p=REJECT sp=REJECT dis=NONE) header.from=google.com
...
To view this discussion on the web visit https://groups.google.com/d/msgid/kasan-dev/20191114180303.66955-2-elver%40google.com.
