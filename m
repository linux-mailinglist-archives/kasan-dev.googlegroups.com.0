Return-Path: <kasan-dev+bncBDWMT3UBYINRBBMNT3CQMGQE64VCYSY@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-oo1-xc3e.google.com (mail-oo1-xc3e.google.com [IPv6:2607:f8b0:4864:20::c3e])
	by mail.lfdr.de (Postfix) with ESMTPS id C1392B306C7
	for <lists+kasan-dev@lfdr.de>; Thu, 21 Aug 2025 22:50:26 +0200 (CEST)
Received: by mail-oo1-xc3e.google.com with SMTP id 006d021491bc7-61da04d1238sf1505700eaf.3
        for <lists+kasan-dev@lfdr.de>; Thu, 21 Aug 2025 13:50:26 -0700 (PDT)
ARC-Seal: i=3; a=rsa-sha256; t=1755809414; cv=pass;
        d=google.com; s=arc-20240605;
        b=
ARC-Message-Signature: i=3; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20240605;
        ...
        bh=xCpRHsW+Iq2GuJwFvcjg8/ZNbZHgGwTyaQXTnDqWiIo=;
        fh=kkiMXAwQo5jtqcFxgk/7aGjvaxVnP+kLaRPozAlNSHA=;
        b=;
        darn=lfdr.de
ARC-Authentication-Results: i=3; gmr-mx.google.com;
       dkim=pass header.i=@Nvidia.com header.s=selector2 header.b=RashZiWu;
       arc=pass (i=1 spf=pass spfdomain=nvidia.com dkim=pass dkdomain=nvidia.com dmarc=pass fromdomain=nvidia.com);
       spf=pass (google.com: domain of ziy@nvidia.com designates 2a01:111:f403:200a::614 as permitted sender) smtp.mailfrom=ziy@nvidia.com;
       dmarc=pass (p=REJECT sp=REJECT dis=NONE) header.from=nvidia.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=googlegroups.com; s=20230601; t=1755809414; x=1756414214; darn=lfdr.de;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
        ...
        bh=xCpRHsW+Iq2GuJwFvcjg8/ZNbZHgGwTyaQXTnDqWiIo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1755809414; x=1756414214;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
        ...
        bh=xCpRHsW+Iq2GuJwFvcjg8/ZNbZHgGwTyaQXTnDqWiIo=;
        b=
X-Forwarded-Encrypted: i=3; AJvYcCUPkCd0SShYjgRUo8bkVYclFc2xjIXYOAmerFDYTf8eYyMw/TYupUjecO/YKdyVfAEBNcb8DQ==@lfdr.de
X-Gm-Message-State: AOJu0YzuouSw3dAzUdsAH9mub9waWjPfRSbN6LGfnYf5JdWOZDuxO1kY
	VV6Twq5152zIFPyjUHunj2fsTTwdKMccYdjbR83EBv8RZoAfOw/kw3Ws
X-Google-Smtp-Source: AGHT+IGT/Trl4BKyFQtn/JXnDbEzSrR2AT8stlagnF7Zlgg/ehv3k/LiYHeFVjsdVILiBNDIqsbWmg==
X-Received: by 2002:a05:6820:61c:b0:61c:bc3:2778 with SMTP id 006d021491bc7-61db9b7746amr279611eaf.3.1755809413636;
        Thu, 21 Aug 2025 13:50:13 -0700 (PDT)
X-BeenThere: kasan-dev@googlegroups.com; h=AZMbMZevIl9xjhVZGPnie864OVUSQ7VQ3xV+PqpTpU0+NiNZEg==
Received: by 2002:a05:6820:a016:b0:61b:943a:28d with SMTP id
 006d021491bc7-61da8a783fels389540eaf.0.-pod-prod-03-us; Thu, 21 Aug 2025
 13:50:13 -0700 (PDT)
X-Forwarded-Encrypted: i=3; AJvYcCUGe0oiy/l8u9yH4jlNSgMhewcM2zSUAJDpHGXeP2oubrNNghfsgPdz3OsD2rVFzjefH5qi4MUsD/g=@googlegroups.com
X-Received: by 2002:a05:6830:3491:b0:742:ff8a:47d7 with SMTP id 46e09a7af769-74500a4019emr514702a34.17.1755809412864;
        Thu, 21 Aug 2025 13:50:12 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1755809412; cv=pass;
        d=google.com; s=arc-20240605;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20240605;
        ...
        b=;
        dara=google.com
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       ...
       spf=pass (google.com: domain of ziy@nvidia.com designates 2a01:111:f403:200a::614 as permitted sender) smtp.mailfrom=ziy@nvidia.com;
       dmarc=pass (p=REJECT sp=REJECT dis=NONE) header.from=nvidia.com
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on20614.outbound.protection.outlook.com. [2a01:111:f403:200a::614])
        by gmr-mx.google.com with ESMTPS id 46e09a7af769-7439204a0b1si26204a34.5.2025.08.21.13.50.12
        for <kasan-dev@googlegroups.com>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 21 Aug 2025 13:50:12 -0700 (PDT)
Received-SPF: pass (google.com: domain of ziy@nvidia.com designates 2a01:111:f403:200a::614 as permitted sender) client-ip=2a01:111:f403:200a::614;
...
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@Nvidia.com header.s=selector2 header.b=RashZiWu;       arc=pass
 (i=1 spf=pass spfdomain=nvidia.com dkim=pass dkdomain=nvidia.com dmarc=pass
 fromdomain=nvidia.com);       spf=pass (google.com: domain of ziy@nvidia.com
 designates 2a01:111:f403:200a::614 as permitted sender) smtp.mailfrom=ziy@nvidia.com;
       dmarc=pass (p=REJECT sp=REJECT dis=NONE) header.from=nvidia.com
...
>>>
>>> As folios and memory sections are naturally aligned to their order-2 si=
ze
>>> in memory, consequently a single folio can no longer span multiple memo=
ry
>>> sections on these problematic kernel configs.
>>>
>>> nth_page() is no longer required when operating within a single compoun=
d
>>> page / folio.
>>>
...
>>> +/*
>>> + * We don't expect any folios that exceed buddy sizes (and consequentl=
y
>>> + * memory sections).
>>> + */
...
>>> + * contiguous. By limiting folios to a single memory section, all foli=
o
...
>>> +#else
>>> +/*
>>> + * There is no real limit on the folio size. We limit them to the maxi=
mum we
>>> + * currently expect.
>>
>> The comment about hugetlbfs is helpful here, since the other folios are =
still
...
8255144-572E-4BB9-BBA0-D446DCBA8D75%40nvidia.com.
