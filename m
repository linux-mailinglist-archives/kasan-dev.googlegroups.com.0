Return-Path: <kasan-dev+bncBCKPFB7SXUERBQUVS7EQMGQEWTUDTTY@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-pl1-x640.google.com (mail-pl1-x640.google.com [IPv6:2607:f8b0:4864:20::640])
	by mail.lfdr.de (Postfix) with ESMTPS id 009ABC85C37
	for <lists+kasan-dev@lfdr.de>; Tue, 25 Nov 2025 16:27:00 +0100 (CET)
Received: by mail-pl1-x640.google.com with SMTP id d9443c01a7336-297f48e81b8sf79492965ad.0
        for <lists+kasan-dev@lfdr.de>; Tue, 25 Nov 2025 07:27:00 -0800 (PST)
ARC-Seal: i=2; a=rsa-sha256; t=1764084419; cv=pass;
        d=google.com; s=arc-20240605;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20240605;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:reply-to:content-disposition
         :mime-version:message-id:subject:cc:to:from:date:dkim-signature;
        bh=rDh5e/xaEG8ZgH0C387cZErs2cgWfGDwScq59CVZ6Gw=;
        fh=tPVKb+gro3AwfGmDRZqW/7YCG1iP/DLcBD6+uq2oD6s=;
        b=;
        darn=lfdr.de
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@redhat.com header.s=mimecast20190719 header.b="VQ/srSEc";
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=googlegroups.com; s=20230601; t=1764084419; x=1764689219; darn=lfdr.de;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
        ...
        bh=rDh5e/xaEG8ZgH0C387cZErs2cgWfGDwScq59CVZ6Gw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1764084419; x=1764689219;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         ...
         :reply-to;
        bh=rDh5e/xaEG8ZgH0C387cZErs2cgWfGDwScq59CVZ6Gw=;
        b=
X-Forwarded-Encrypted: i=2; AJvYcCWh0VnrlDXnEmYTuweH+Cu9tkkmRde03e4ijAITfjO+rkZWpShKtt20TvEgMF1E9mOWjyLKOQ==@lfdr.de
X-Gm-Message-State: AOJu0YyACEabg4e7wPN/WtBXKqT/78qdE+3EujwoGzxvflNlSV0yqvT+
	58Q6+XIB7KviJsNrlGYIYB+NrkfiQbUjJ8gEs98BcjoVrtifZ7llGarf
X-Google-Smtp-Source: AGHT+IFrnhiN2rtNCe6LUPNqzBZmnwQJBQuWm9CXmekfu4IO8r6kc2cAqU5+epZ0GFIIUSInayAVfw==
X-Received: by 2002:a17:902:dacb:b0:269:b2e5:900d with SMTP id d9443c01a7336-29b6beebec7mr184269465ad.5.1764084418508;
        Tue, 25 Nov 2025 07:26:58 -0800 (PST)
X-BeenThere: kasan-dev@googlegroups.com; h="Ae8XA+ZCwPYX5WzEqUUh0f/hUXyBNdaEBhoiICE+dMebJ6Ishg=="
Received: by 2002:a17:903:1a0d:b0:295:5d08:cca6 with SMTP id
 d9443c01a7336-29b5b199428ls28377515ad.1.-pod-prod-00-us; Tue, 25 Nov 2025
 07:26:54 -0800 (PST)
X-Received: by 2002:a17:903:1110:b0:297:eafd:5c19 with SMTP id d9443c01a7336-29b5e2f78d5mr232074115ad.10.1764084414357;
        Tue, 25 Nov 2025 07:26:54 -0800 (PST)
ARC-Seal: i=1; a=rsa-sha256; t=1764084414; cv=none;
        d=google.com; s=arc-20240605;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20240605;
        h=content-disposition:mime-version:message-id:subject:cc:to:from:date
         :dkim-signature;
        bh=XPT1ajiPu1XC9w1hOxlMUMWQLOEFwpy1b5kW7NNurrY=;
        fh=WzRBWPA8wT018NJ2jV3eK9kgxvaqM6I5JPUsVylzIa8=;
        b=;
        dara=google.com
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com. [170.10.129.124])
        by gmr-mx.google.com with ESMTPS id 98e67ed59e1d1-3475fdd6473si35450a91.2.2025.11.25.07.26.53
...
Received: from mx-prod-mc-05.mail-002.prod.us-west-2.aws.redhat.com
 ...
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-661-b-yr4GFhOdusjT-2Fvwklw-1; Tue,
 25 Nov 2025 10:26:45 -0500
X-MC-Unique: b-yr4GFhOdusjT-2Fvwklw-1
X-Mimecast-MFC-AGG-ID: b-yr4GFhOdusjT-2Fvwklw_1764084401
Received: from mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.12])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-05.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 66D5619560BD;
	Tue, 25 Nov 2025 15:26:41 +0000 (UTC)
Received: from localhost (unknown [10.72.112.114])
	by mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 7DAE519560B2;
	Tue, 25 Nov 2025 15:26:37 +0000 (UTC)
Date: Tue, 25 Nov 2025 23:26:32 +0800
From: "'Baoquan He' via kasan-dev" <kasan-dev@googlegroups.com>
To: kasan-dev@googlegroups.com, bpf@vger.kernel.org
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="Tv1w/q7LXWl09/sN"
Content-Disposition: inline
X-Scanned-By: MIMEDefang 3.0 on 10.30.177.12
X-Original-Sender: bhe@redhat.com
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@redhat.com header.s=mimecast20190719 header.b="VQ/srSEc";
...
To view this discussion visit https://groups.google.com/d/msgid/kasan-dev/aSXKqJTkZPNskFop%40MiWiFi-R3L-srv.
...
# Linux/arm64 6.18.0-rc7 Kernel Configuration
#
...
CONFIG_BUILD_SALT="6.17.8-200.fc42.aarch64"
...
# CONFIG_SENSORS_MACSMC_HWMON is not set
...
# CONFIG_RZG3S_THERMAL is not set
...
#
# CONFIG_VIDEO_MALI_C55 is not set
...
# CONFIG_VIDEO_RZV2H_IVC is not set
...
# CONFIG_VIDEO_IMX111 is not set
...
# CONFIG_DRM_DW_HDMI_QP_CEC is not set
...
# CONFIG_SCSI_UFS_AMD_VERSAL2 is not set
CONFIG_MEMSTICK=m
...
# CONFIG_INFINIBAND_BNG_RE is not set
...
# CONFIG_EDAC_CORTEX_A72 is not set
# CONFIG_EDAC_VERSALNET is not set
CONFIG_RTC_LIB=y
CONFIG_RTC_CLASS=y
...
# CONFIG_NVMEM_S32G_OCOTP is not set
CONFIG_NVMEM_QCOM_QFPROM=m
CONFIG_NVMEM_QCOM_SEC_QFPROM=m
# CONFIG_NVMEM_QNAP_MCU_EEPROM is not set
...
# CONFIG_INTERCONNECT_QCOM_GLYMUR is not set
# CONFIG_INTERCONNECT_QCOM_KAANAPALI is not set
...
# CONFIG_CORESIGHT_TNOC is not set
