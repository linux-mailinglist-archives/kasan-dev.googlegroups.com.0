Return-Path: <kasan-dev+bncBCCMH5WKTMGRBJX6RSMQMGQE4FN3Y6Q@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-lf1-x13f.google.com (mail-lf1-x13f.google.com [IPv6:2a00:1450:4864:20::13f])
	by mail.lfdr.de (Postfix) with ESMTPS id 005215B9E08
	for <lists+kasan-dev@lfdr.de>; Thu, 15 Sep 2022 17:05:10 +0200 (CEST)
Received: by mail-lf1-x13f.google.com with SMTP id bp7-20020a056512158700b00492d0a98377sf5607538lfb.15
        for <lists+kasan-dev@lfdr.de>; Thu, 15 Sep 2022 08:05:11 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1663254310; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         ...
         :date:dkim-signature;
        bh=8dLcvi3Oa3rdV9y0dL76Cmk5uF8he+QbU0Z+XFJlbwU=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@google.com header.s=20210112 header.b="angyTB/b";
       spf=pass (google.com: domain of 3jd8jywykcu8x2zuv8x55x2v.t531r9r4-uvcx55x2vx85b69.t53@flex--glider.bounces.google.com designates 2a00:1450:4864:20::549 as permitted sender) smtp.mailfrom=3JD8jYwYKCU8x2zuv8x55x2v.t531r9r4-uvCx55x2vx85B69.t53@flex--glider.bounces.google.com;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=8dLcvi3Oa3rdV9y0dL76Cmk5uF8he+QbU0Z+XFJlbwU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         ...
         :date;
        bh=8dLcvi3Oa3rdV9y0dL76Cmk5uF8he+QbU0Z+XFJlbwU=;
        b=
X-Gm-Message-State: ACrzQf2yh6mQ+uqtIHFyeDDxk+IlotXKH87IbzzB1YScSh7nwJB2kv32
	gqpMkwMkCZBf2R07uvcV3Ew=
X-Google-Smtp-Source: AMsMyM41/XGtpdSdFLO3FtT2n5+tlbXD5wRY1eOVf+qwB4+5iFFmtyUabK8V2ELsyvPXYKvNMPKjYA==
X-Received: by 2002:a05:651c:158c:b0:250:a23d:2701 with SMTP id h12-20020a05651c158c00b00250a23d2701mr49549ljq.475.1663254310524;
        Thu, 15 Sep 2022 08:05:10 -0700 (PDT)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:ac2:5e24:0:b0:49a:b814:856d with SMTP id o4-20020ac25e24000000b0049ab814856dls1227315lfg.1.-pod-prod-gmail;
 Thu, 15 Sep 2022 08:05:09 -0700 (PDT)
X-Received: by 2002:a05:6512:312f:b0:498:f40f:37b5 with SMTP id p15-20020a056512312f00b00498f40f37b5mr114787lfd.240.1663254309334;
        Thu, 15 Sep 2022 08:05:09 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1663254309; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=content-transfer-encoding:cc:to:from:subject:message-id:references
         :mime-version:in-reply-to:date:dkim-signature;
        bh=tRIgLlwATZdT+TTKtlpJloEvtY4wIpIACXvVBZZrTN0=;
        b=
...
Received: from mail-ed1-x549.google.com (mail-ed1-x549.google.com. [2a00:1450:4864:20::549])
        by gmr-mx.google.com with ESMTPS id bd8-20020a05651c168800b0026c36a55327si6882ljb.4.2022.09.15.08.05.09
        for <kasan-dev@googlegroups.com>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 15 Sep 2022 08:05:09 -0700 (PDT)
Received-SPF: pass (google.com: domain of 3jd8jywykcu8x2zuv8x55x2v.t531r9r4-uvcx55x2vx85b69.t53@flex--glider.bounces.google.com designates 2a00:1450:4864:20::549 as permitted sender) client-ip=2a00:1450:4864:20::549;
Received: by mail-ed1-x549.google.com with SMTP id m3-20020a056402430300b004512f6268dbso12392049edc.23
        for <kasan-dev@googlegroups.com>; Thu, 15 Sep 2022 08:05:09 -0700 (PDT)
X-Received: from glider.muc.corp.google.com ([2a00:79e0:9c:201:686d:27b5:495:85b7])
 (user=glider job=sendgmr) by 2002:a17:907:2722:b0:77e:d84d:9e09 with SMTP id
 d2-20020a170907272200b0077ed84d9e09mr268366ejl.679.1663254308601; Thu, 15 Sep
 2022 08:05:08 -0700 (PDT)
Date: Thu, 15 Sep 2022 17:03:45 +0200
In-Reply-To: <20220915150417.722975-1-glider@google.com>
Mime-Version: 1.0
References: <20220915150417.722975-1-glider@google.com>
X-Mailer: git-send-email 2.37.2.789.g6183377224-goog
Message-ID: <20220915150417.722975-12-glider@google.com>
...
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@google.com header.s=20210112 header.b="angyTB/b";       spf=pass
 (google.com: domain of 3jd8jywykcu8x2zuv8x55x2v.t531r9r4-uvcx55x2vx85b69.t53@flex--glider.bounces.google.com
 designates 2a00:1450:4864:20::549 as permitted sender) smtp.mailfrom=3JD8jYwYKCU8x2zuv8x55x2v.t531r9r4-uvCx55x2vx85B69.t53@flex--glider.bounces.google.com;
       dmarc=pass (p=REJECT sp=REJECT dis=NONE) header.from=google.com
...
+	 */
+	BUILD_BUG_ON(
+		(1 << STACK_DEPOT_EXTRA_BITS) <=3D (KMSAN_MAX_ORIGIN_DEPTH << 1));
+
...
+	 */
+	if (depth =3D=3D KMSAN_MAX_ORIGIN_DEPTH)
+		return id;
+
+	depth++;
...
+		depth =3D kmsan_depth_from_eb(stack_depot_get_extra_bits(origin));
...
kasan-dev/20220915150417.722975-12-glider%40google.com.
