Return-Path: <kasan-dev+bncBAABBX4W5P2QKGQEHP4QTRA@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-pl1-x63b.google.com (mail-pl1-x63b.google.com [IPv6:2607:f8b0:4864:20::63b])
	by mail.lfdr.de (Postfix) with ESMTPS id 8B21C1CFA4B
	for <lists+kasan-dev@lfdr.de>; Tue, 12 May 2020 18:14:24 +0200 (CEST)
Received: by mail-pl1-x63b.google.com with SMTP id 18sf10443598pll.3
        for <lists+kasan-dev@lfdr.de>; Tue, 12 May 2020 09:14:24 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1589300063; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        bh=64mzZFn6ALPKlWIY8v8gVDpmS7DMYVI2Ms2fn5LbRhc=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@kernel.org header.s=default header.b=L1OgTNMV;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=64mzZFn6ALPKlWIY8v8gVDpmS7DMYVI2Ms2fn5LbRhc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=64mzZFn6ALPKlWIY8v8gVDpmS7DMYVI2Ms2fn5LbRhc=;
        b=
Sender: kasan-dev@googlegroups.com
X-Gm-Message-State: AGi0PubsSJBEu3SrFZTWuuSsj57KHeg2WdaeUFNQopIYYDo4OirKkGr0
	QLNJe+kRS+J5XuV6OfaK9XE=
X-Google-Smtp-Source: APiQypKZH+POAHEtZG+pBzhIlk9fD42C4dgTDLGts922efNfZxNLqMQEzGmtD4U6FE7mYHumw2o4Dg==
X-Received: by 2002:a17:90a:9f95:: with SMTP id o21mr30323938pjp.229.1589300063212;
        Tue, 12 May 2020 09:14:23 -0700 (PDT)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a17:90a:4f04:: with SMTP id p4ls1612655pjh.3.canary-gmail;
 Tue, 12 May 2020 09:14:22 -0700 (PDT)
X-Received: by 2002:a17:90a:8a06:: with SMTP id w6mr30869981pjn.191.1589300062842;
        Tue, 12 May 2020 09:14:22 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1589300062; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=user-agent:in-reply-to:content-disposition:mime-version:references
         :reply-to:message-id:subject:cc:to:from:date:dkim-signature;
        bh=XyUckO50cXHb5EdJ76c7HRAKWzcASP0q9Q3mNQMYl0U=;
        b=
...
Received: from mail.kernel.org (mail.kernel.org. [198.145.29.99])
        by gmr-mx.google.com with ESMTPS id e6si172907pgr.1.2020.05.12.09.14.22
...
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@kernel.org header.s=default header.b=L1OgTNMV;       spf=pass
...
You received this message because you are subscribed to the Google Groups "kasan-dev" group.
To unsubscribe from this group and stop receiving emails from it, send an email to kasan-dev+unsubscribe@googlegroups.com.
To view this discussion on the web visit https://groups.google.com/d/msgid/kasan-dev/20200512161422.GG2869%40paulmck-ThinkPad-P72.
