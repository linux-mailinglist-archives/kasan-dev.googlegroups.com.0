Return-Path: <kasan-dev+bncBC4LXIPCY4NRBMWR2SMQMGQEXAUC6UA@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-ed1-x53b.google.com (mail-ed1-x53b.google.com [IPv6:2a00:1450:4864:20::53b])
	by mail.lfdr.de (Postfix) with ESMTPS id 016545EED13
	for <lists+kasan-dev@lfdr.de>; Thu, 29 Sep 2022 07:10:12 +0200 (CEST)
Received: by mail-ed1-x53b.google.com with SMTP id y14-20020a056402440e00b0044301c7ccd9sf346298eda.19
        for <lists+kasan-dev@lfdr.de>; Wed, 28 Sep 2022 22:10:11 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1664428211; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         ...
         :dkim-signature;
        bh=mel4ejnWn383apW1k+RkG363S/iIRHe7iycLLi1nRTs=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@intel.com header.s=Intel header.b=SZZspaiV;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         ...
         :subject:date;
        bh=mel4ejnWn383apW1k+RkG363S/iIRHe7iycLLi1nRTs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=mel4ejnWn383apW1k+RkG363S/iIRHe7iycLLi1nRTs=;
        b=
Sender: kasan-dev@googlegroups.com
X-Gm-Message-State: ACrzQf10+2EkZrHNgqq2AFUizBbJifyF0l9+EJSxd5Pn2xr/DAiERE72
	MLTB+GJy8wIBYGtRVVqzjwo=
X-Google-Smtp-Source: AMsMyM720ERtxrFHiiq0FMWHeGUW+fWMswhpd7KXR1yHKVrJT0trDP8zooqPoKF6+NDmfWQC3nQZLw==
X-Received: by 2002:a17:907:c0e:b0:783:a5c3:eafc with SMTP id ga14-20020a1709070c0e00b00783a5c3eafcmr1176357ejc.29.1664428211172;
        Wed, 28 Sep 2022 22:10:11 -0700 (PDT)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a17:906:5cc:b0:726:abf9:5f2e with SMTP id
 t12-20020a17090605cc00b00726abf95f2els236083ejt.9.-pod-prod-gmail; Wed, 28
 Sep 2022 22:10:10 -0700 (PDT)
X-Received: by 2002:a17:907:a058:b0:77d:6211:5735 with SMTP id gz24-20020a170907a05800b0077d62115735mr1134281ejc.87.1664428209959;
        Wed, 28 Sep 2022 22:10:09 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1664428209; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:dkim-signature;
        bh=ff//wZYgqd4tFZAYBK9VAneA0K9RMU4IYlBfmdJSbcY=;
        b=
...
Received: from mga01.intel.com (mga01.intel.com. [192.55.52.88])
        by gmr-mx.google.com with ESMTPS id c19-20020aa7df13000000b0044ea33a8ac8si292565edy.2.2022.09.28.22.10.08
        for <kasan-dev@googlegroups.com>
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Wed, 28 Sep 2022 22:10:09 -0700 (PDT)
Received-SPF: pass (google.com: domain of lkp@intel.com designates 192.55.52.88 as permitted sender) client-ip=192.55.52.88;
X-IronPort-AV: E=McAfee;i="6500,9779,10484"; a="328168113"
X-IronPort-AV: E=Sophos;i="5.93,354,1654585200"; 
   d="scan'208";a="328168113"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Sep 2022 22:10:07 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10484"; a="867239368"
X-IronPort-AV: E=Sophos;i="5.93,354,1654585200"; 
   d="scan'208";a="867239368"
Received: from lkp-server01.sh.intel.com (HELO 6126f2790925) ([10.239.97.150])
  by fmsmga006.fm.intel.com with ESMTP; 28 Sep 2022 22:10:03 -0700
Received: from kbuild by 6126f2790925 with local (Exim 4.96)
	(envelope-from <lkp@intel.com>)
	id 1odloB-0000dI-0W;
	Thu, 29 Sep 2022 05:10:03 +0000
Date: Thu, 29 Sep 2022 13:09:20 +0800
...
Subject: Re: [PATCH v2] kasan: also display registers for reports from HW
 exceptions
Message-ID: <202209291221.YCyFn42J-lkp@intel.com>
References: <20220927012044.2794384-1-pcc@google.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="z/qHIY4vH2/Q24mb"
Content-Disposition: inline
In-Reply-To: <20220927012044.2794384-1-pcc@google.com>
X-Original-Sender: lkp@intel.com
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@intel.com header.s=Intel header.b=SZZspaiV;       spf=pass
...
All warnings (new ones prefixed by >>):
   ...
   #define __do_outsl(p, b, n)     writesl((PCI_IO_ADDR)_IO_BASE+(p),(b),(n))
                                           ~~~~~~~~~~~~~~~~~~~~~^
>> mm/kasan/report.c:514:6: warning: no previous prototype for function 'kasan_report_regs' [-Wmissing-prototypes]
   bool kasan_report_regs(unsigned long addr, size_t size, bool is_write,
        ^
   mm/kasan/report.c:514:1: note: declare 'static' if the function is not intended to be used outside of this translation unit
   bool kasan_report_regs(unsigned long addr, size_t size, bool is_write,
   ^
   static 
...
vim +/kasan_report_regs +514 mm/kasan/report.c

   513	
 > 514	bool kasan_report_regs(unsigned long addr, size_t size, bool is_write,
   515			       struct pt_regs *regs)
   516	{
   517		return __kasan_report(addr, size, is_write, instruction_pointer(regs),
   518				      regs);
   519	}
   520	
...
To view this discussion on the web visit https://groups.google.com/d/msgid/kasan-dev/202209291221.YCyFn42J-lkp%40intel.com.
