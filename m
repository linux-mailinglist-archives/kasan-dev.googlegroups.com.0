Return-Path: <kasan-dev+bncBCLI747UVAFRBX62TGOQMGQEYCYQPPI@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-lj1-x23f.google.com (mail-lj1-x23f.google.com [IPv6:2a00:1450:4864:20::23f])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E66D65582F
	for <lists+kasan-dev@lfdr.de>; Sat, 24 Dec 2022 04:09:21 +0100 (CET)
Received: by mail-lj1-x23f.google.com with SMTP id b31-20020a05651c0b1f00b0027a003c5d43sf1467499ljr.7
        for <lists+kasan-dev@lfdr.de>; Fri, 23 Dec 2022 19:09:21 -0800 (PST)
ARC-Seal: i=2; a=rsa-sha256; t=1671851360; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        bh=6hW2JjrYu1GS/rBzXDvtziEunSxyekvJOtDUcK+193g=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@zx2c4.com header.s=20210105 header.b=Yi5AVvWn;
       spf=pass (google.com: domain of srs0=zjrg=4w=zx2c4.com=jason@kernel.org designates 2604:1380:4601:e00::1 as permitted sender) smtp.mailfrom="SRS0=zjrg=4W=zx2c4.com=Jason@kernel.org";
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=6hW2JjrYu1GS/rBzXDvtziEunSxyekvJOtDUcK+193g=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=6hW2JjrYu1GS/rBzXDvtziEunSxyekvJOtDUcK+193g=;
        b=
X-Gm-Message-State: AFqh2krOp257rNvkC1MrUbxOXfnfH8K3S4MIFPW4DB4Ssv784ZGz1laQ
	sqEbNVx+GKHB9l6T67nprX0=
X-Google-Smtp-Source: AMrXdXtCsQW+ksWvUJsJJ+Ln81NOECd5MpbFiIDmXKKlvmC2vjr5NuwaA8EYMooN29DFDaq77Gm36A==
X-Received: by 2002:a19:8c5a:0:b0:4b5:b3ef:42df with SMTP id i26-20020a198c5a000000b004b5b3ef42dfmr1153571lfj.318.1671851360144;
        Fri, 23 Dec 2022 19:09:20 -0800 (PST)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a2e:84ca:0:b0:277:4af7:14ea with SMTP id q10-20020a2e84ca000000b002774af714eals910006ljh.2.-pod-prod-gmail;
 Fri, 23 Dec 2022 19:09:18 -0800 (PST)
X-Received: by 2002:a2e:b16a:0:b0:277:21c8:a935 with SMTP id a10-20020a2eb16a000000b0027721c8a935mr4396436ljm.28.1671851358767;
        Fri, 23 Dec 2022 19:09:18 -0800 (PST)
ARC-Seal: i=1; a=rsa-sha256; t=1671851358; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=in-reply-to:content-transfer-encoding:content-disposition
         :mime-version:references:message-id:subject:cc:to:from:date
         :dkim-signature;
        bh=T3SLC53r1miAGtKIZyd/0QO3Ubv4MNs8XxU++RoBklw=;
        b=
...
Received: from ams.source.kernel.org (ams.source.kernel.org. [2604:1380:4601:e00::1])
        by gmr-mx.google.com with ESMTPS id bi27-20020a05651c231b00b0027fb7252b31si45350ljb.5.2022.12.23.19.09.17
        for <kasan-dev@googlegroups.com>
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Fri, 23 Dec 2022 19:09:18 -0800 (PST)
Received-SPF: pass (google.com: domain of srs0=zjrg=4w=zx2c4.com=jason@kernel.org designates 2604:1380:4601:e00::1 as permitted sender) client-ip=2604:1380:4601:e00::1;
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.source.kernel.org (Postfix) with ESMTPS id 1B099B81EE6;
	Sat, 24 Dec 2022 03:09:17 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 40E37C433D2;
	Sat, 24 Dec 2022 03:09:14 +0000 (UTC)
Received: by mail.zx2c4.com (ZX2C4 Mail Server) with ESMTPSA id 8fc6c102 (TLSv1.3:TLS_AES_256_GCM_SHA384:256:NO);
	Sat, 24 Dec 2022 03:09:10 +0000 (UTC)
Date: Sat, 24 Dec 2022 04:09:08 +0100
...
Message-ID: <Y6ZtVGtFpUNQP+KU@zx2c4.com>
...
In-Reply-To: <Y6ZESPx4ettBLuMt@sol.localdomain>
X-Original-Sender: jason@zx2c4.com
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@zx2c4.com header.s=20210105 header.b=Yi5AVvWn;       spf=pass
 (google.com: domain of srs0=zjrg=4w=zx2c4.com=jason@kernel.org designates
 2604:1380:4601:e00::1 as permitted sender) smtp.mailfrom="SRS0=zjrg=4W=zx2c4.com=Jason@kernel.org";
       dmarc=pass (p=QUARANTINE sp=QUARANTINE dis=NONE) header.from=zx2c4.com
...
> > This reverts 3824e25db1 ("x86: disable rng seeding via setup_data"), bu=
t
...
> After upgrading to QEMU 7.2, Linux 6.1 no longer boots with some configs.=
  There
> is no output at all.  I bisected it to this commit, and I verified that t=
he
...
> --- a/hw/i386/pc_piix.c
> +++ b/hw/i386/pc_piix.c
> @@ -441,6 +441,7 @@ static void pc_i440fx_8_0_machine_options(MachineClas=
s *m)
...
kasan-dev/Y6ZtVGtFpUNQP%2BKU%40zx2c4.com.
