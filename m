Return-Path: <kasan-dev+bncBCN253FDVEJRBSVPQKNAMGQENINK7MY@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-lj1-x240.google.com (mail-lj1-x240.google.com [IPv6:2a00:1450:4864:20::240])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A5C45F7FB9
	for <lists+kasan-dev@lfdr.de>; Fri,  7 Oct 2022 23:19:07 +0200 (CEST)
Received: by mail-lj1-x240.google.com with SMTP id bn39-20020a05651c17a700b0026309143eeesf2387015ljb.4
        for <lists+kasan-dev@lfdr.de>; Fri, 07 Oct 2022 14:19:07 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1665177547; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        bh=5SSX0xRp3V53E7qOdaogwXWGW6cfXPHdbh+mCeFIAMs=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@kernel.org header.s=k20201202 header.b=htMu1wUZ;
       spf=pass (google.com: domain of djwong@kernel.org designates 145.40.68.75 as permitted sender) smtp.mailfrom=djwong@kernel.org;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=5SSX0xRp3V53E7qOdaogwXWGW6cfXPHdbh+mCeFIAMs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=5SSX0xRp3V53E7qOdaogwXWGW6cfXPHdbh+mCeFIAMs=;
        b=
Sender: kasan-dev@googlegroups.com
X-Gm-Message-State: ACrzQf2rGiUrYTdCy5KJQtj+P1puiZ5qV/4qfcQS94i3DH+L3p88DmY8
	xLGY46rtRtXwvTDaTzw73TA=
X-Google-Smtp-Source: AMsMyM57sp4SMp/fdwGR4cNz+LVOjKGhRR0bbXyI7CAZTO2NilEFBviIKznHgHVISp5Z1xataS3a6w==
X-Received: by 2002:a2e:2e0d:0:b0:26e:3d1:4d0b with SMTP id u13-20020a2e2e0d000000b0026e03d14d0bmr2417435lju.438.1665177546733;
        Fri, 07 Oct 2022 14:19:06 -0700 (PDT)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a05:651c:178d:b0:26d:cef8:8887 with SMTP id
 bn13-20020a05651c178d00b0026dcef88887ls1234425ljb.7.-pod-prod-gmail; Fri, 07
 Oct 2022 14:19:05 -0700 (PDT)
X-Received: by 2002:a2e:a588:0:b0:26c:636d:66a6 with SMTP id m8-20020a2ea588000000b0026c636d66a6mr2542881ljp.369.1665177545294;
        Fri, 07 Oct 2022 14:19:05 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1665177545; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=in-reply-to:content-transfer-encoding:content-disposition
         :mime-version:references:message-id:subject:cc:to:from:date
         :dkim-signature;
        bh=Ca9CPWcstnc/7Gnf1KckJqhJCNWTSFMe7VInw7wpn58=;
        b=
...
Received: from ams.source.kernel.org (ams.source.kernel.org. [145.40.68.75])
        by gmr-mx.google.com with ESMTPS id h10-20020a2ea48a000000b0026d92a5f977si124402lji.1.2022.10.07.14.19.05
        for <kasan-dev@googlegroups.com>
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Fri, 07 Oct 2022 14:19:05 -0700 (PDT)
Received-SPF: pass (google.com: domain of djwong@kernel.org designates 145.40.68.75 as permitted sender) client-ip=145.40.68.75;
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.source.kernel.org (Postfix) with ESMTPS id 53DBBB82478;
	Fri,  7 Oct 2022 21:19:04 +0000 (UTC)
...
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@kernel.org header.s=k20201202 header.b=htMu1wUZ;       spf=pass
 (google.com: domain of djwong@kernel.org designates 145.40.68.75 as permitted
 sender) smtp.mailfrom=djwong@kernel.org;       dmarc=pass (p=NONE sp=NONE
...
>=20
> diff --git a/Documentation/networking/filter.rst b/Documentation/networki=
ng/filter.rst
> index 43cdc4d34745..f69da5074860 100644
> --- a/Documentation/networking/filter.rst
> +++ b/Documentation/networking/filter.rst
> @@ -305,7 +305,7 @@ Possible BPF extensions are shown in the following ta=
ble:
...
> @@ -37,7 +37,7 @@ static inline int mmap_is_legacy(struct rlimit *rlim_st=
ack)
> =20
>  unsigned long arch_mmap_rnd(void)
>  {
...
> diff --git a/drivers/gpu/drm/i915/i915_gem_gtt.c b/drivers/gpu/drm/i915/i=
915_gem_gtt.c
> index 329ff75b80b9..7bd1861ddbdf 100644
> --- a/drivers/gpu/drm/i915/i915_gem_gtt.c
> +++ b/drivers/gpu/drm/i915/i915_gem_gtt.c
> @@ -137,12 +137,12 @@ static u64 random_offset(u64 start, u64 end, u64 le=
n, u64 align)
...
> diff --git a/drivers/gpu/drm/selftests/test-drm_buddy.c b/drivers/gpu/drm=
/selftests/test-drm_buddy.c
...
=3D0x%x\n",
>  		random_seed);
> diff --git a/drivers/gpu/drm/selftests/test-drm_mm.c b/drivers/gpu/drm/se=
lftests/test-drm_mm.c
...
> +		random_seed =3D get_random_u32();
> =20
>  	pr_info("Testing DRM range manager (struct drm_mm), with random_seed=3D=
0x%x max_iterations=3D%u max_prime=3D%u\n",
...
> @@ -850,7 +850,7 @@ void hfi1_kern_init_ctxt_generations(struct hfi1_ctxt=
data *rcd)
>  	int i;
> =20
...
>  	}
>  }
> diff --git a/drivers/infiniband/hw/mlx4/mad.c b/drivers/infiniband/hw/mlx=
4/mad.c
...
> diff --git a/drivers/infiniband/ulp/ipoib/ipoib_cm.c b/drivers/infiniband=
/ulp/ipoib/ipoib_cm.c
> index fd9d7f2c4d64..a605cf66b83e 100644
> --- a/drivers/infiniband/ulp/ipoib/ipoib_cm.c
> +++ b/drivers/infiniband/ulp/ipoib/ipoib_cm.c
> @@ -465,7 +465,7 @@ static int ipoib_cm_req_handler(struct ib_cm_id *cm_i=
d,
>  		goto err_qp;
>  	}
> =20
...
>  		/*
> diff --git a/drivers/media/test-drivers/vivid/vivid-touch-cap.c b/drivers=
/media/test-drivers/vivid/vivid-touch-cap.c
> index 792660a85bc1..6cc32eb54f9d 100644
> --- a/drivers/media/test-drivers/vivid/vivid-touch-cap.c
> +++ b/drivers/media/test-drivers/vivid/vivid-touch-cap.c
> @@ -210,7 +210,7 @@ static void vivid_fill_buff_noise(__s16 *tch_buf, int=
 size)
> =20
...
>  		if (rand % 10)
>  			tch_buf[i] =3D 0;
> @@ -272,7 +272,7 @@ void vivid_fillbuff_tch(struct vivid_dev *dev, struct=
 vivid_buffer *buf)
>  		return;
> =20
...
> =20
>  	switch (test_pattern) {
> diff --git a/drivers/misc/habanalabs/gaudi2/gaudi2.c b/drivers/misc/haban=
alabs/gaudi2/gaudi2.c
> index 98336a1a84b0..413b284bf224 100644
> --- a/drivers/misc/habanalabs/gaudi2/gaudi2.c
> +++ b/drivers/misc/habanalabs/gaudi2/gaudi2.c
> @@ -2917,7 +2917,7 @@ static void gaudi2_user_interrupt_setup(struct hl_d=
evice *hdev)
> =20
...
> @@ -4806,7 +4806,7 @@ static u32 bond_rr_gen_slave_id(struct bonding *bon=
d)
> =20
...
> diff --git a/drivers/net/ethernet/broadcom/cnic.c b/drivers/net/ethernet/=
broadcom/cnic.c
> index f597b313acaa..2198e35d9e18 100644
> --- a/drivers/net/ethernet/broadcom/cnic.c
> +++ b/drivers/net/ethernet/broadcom/cnic.c
> @@ -4164,7 +4164,7 @@ static int cnic_cm_init_bnx2_hw(struct cnic_dev *de=
v)
>  {
>  	u32 seed;
> =20
...
> +++ b/drivers/net/ethernet/chelsio/inline_crypto/chtls/chtls_cm.c
> @@ -1063,7 +1063,7 @@ static void chtls_pass_accept_rpl(struct sk_buff *s=
kb,
...
> diff --git a/drivers/net/ethernet/rocker/rocker_main.c b/drivers/net/ethe=
rnet/rocker/rocker_main.c
> index fc83ec23bd1d..8c3bbafabb07 100644
> --- a/drivers/net/ethernet/rocker/rocker_main.c
> +++ b/drivers/net/ethernet/rocker/rocker_main.c
> @@ -129,7 +129,7 @@ static int rocker_reg_test(const struct rocker *rocke=
r)
>  	u64 test_reg;
>  	u64 rnd;
> =20
...
> @@ -139,9 +139,9 @@ static int rocker_reg_test(const struct rocker *rocke=
r)
>  		return -EIO;
>  	}
> =20
...
> diff --git a/drivers/net/wireless/broadcom/brcm80211/brcmfmac/pno.c b/dri=
vers/net/wireless/broadcom/brcm80211/brcmfmac/pno.c
...
> diff --git a/drivers/net/wireless/marvell/mwifiex/cfg80211.c b/drivers/ne=
t/wireless/marvell/mwifiex/cfg80211.c
> index 134114ac1ac0..4fbb5c876b12 100644
> --- a/drivers/net/wireless/marvell/mwifiex/cfg80211.c
> +++ b/drivers/net/wireless/marvell/mwifiex/cfg80211.c
> @@ -238,7 +238,7 @@ mwifiex_cfg80211_mgmt_tx(struct wiphy *wiphy, struct =
wireless_dev *wdev,
...
> @@ -302,7 +302,7 @@ mwifiex_cfg80211_remain_on_channel(struct wiphy *wiph=
y,
>  					 duration);
> =20
>  	if (!ret) {
...
> =20
> diff --git a/drivers/net/wireless/microchip/wilc1000/cfg80211.c b/drivers=
/net/wireless/microchip/wilc1000/cfg80211.c
...
> =20
> diff --git a/drivers/net/wireless/quantenna/qtnfmac/cfg80211.c b/drivers/=
net/wireless/quantenna/qtnfmac/cfg80211.c
...
> @@ -254,7 +254,7 @@ static void send_act_open_req(struct cxgbi_sock *csk,=
 struct sk_buff *skb,
...
> @@ -282,7 +282,7 @@ static void send_act_open_req(struct cxgbi_sock *csk,=
 struct sk_buff *skb,
>  	} else {
...
> @@ -1202,7 +1202,7 @@ cxgbit_pass_accept_rpl(struct cxgbit_sock *csk, str=
uct cpl_pass_accept_req *req)
...
> =20
> diff --git a/drivers/thunderbolt/xdomain.c b/drivers/thunderbolt/xdomain.=
c
...
> --- a/fs/exfat/inode.c
> +++ b/fs/exfat/inode.c
> @@ -552,7 +552,7 @@ static int exfat_fill_inode(struct inode *inode, stru=
ct exfat_dir_entry *info)
...
> --- a/fs/ext4/ialloc.c
> +++ b/fs/ext4/ialloc.c
> @@ -1279,7 +1279,7 @@ struct inode *__ext4_new_inode(struct user_namespac=
e *mnt_userns,
...
> --- a/fs/f2fs/namei.c
> +++ b/fs/f2fs/namei.c
> @@ -50,7 +50,7 @@ static struct inode *f2fs_new_inode(struct user_namespa=
ce *mnt_userns,
>  	inode->i_blocks =3D 0;
>  	inode->i_mtime =3D inode->i_atime =3D inode->i_ctime =3D current_time(i=
node);
...
> --- a/fs/fat/inode.c
> +++ b/fs/fat/inode.c
> @@ -523,7 +523,7 @@ int fat_fill_inode(struct inode *inode, struct msdos_=
dir_entry *de)
>  	inode->i_uid =3D sbi->options.fs_uid;
>  	inode->i_gid =3D sbi->options.fs_gid;
>  	inode_inc_iversion(inode);
...
> --- a/fs/ntfs3/fslog.c
> +++ b/fs/ntfs3/fslog.c
> @@ -3819,7 +3819,7 @@ int log_replay(struct ntfs_inode *ni, bool *initial=
ized)
>  		}
> =20
...
>  		log->ra =3D ra;
> =20
> @@ -3893,7 +3893,7 @@ int log_replay(struct ntfs_inode *ni, bool *initial=
ized)
> =20
...
> @@ -4044,7 +4044,7 @@ int log_replay(struct ntfs_inode *ni, bool *initial=
ized)
...
> @@ -503,7 +503,7 @@ static void mark_inode_clean(struct ubifs_info *c, st=
ruct ubifs_inode *ui)
...
>  	 */
>  	error =3D xfs_ialloc_inode_init(args.mp, tp, NULL, newlen, pag->pag_agn=
o,
...
> --- a/include/net/red.h
> +++ b/include/net/red.h
> @@ -364,7 +364,7 @@ static inline unsigned long red_calc_qavg(const struc=
t red_parms *p,
> =20
...
> @@ -2091,7 +2091,7 @@ static inline kuid_t sock_net_uid(const struct net =
...
> @@ -546,7 +546,7 @@ static struct bpf_map *htab_map_alloc(union bpf_attr =
*attr)
...
> @@ -13317,7 +13317,7 @@ static int opt_subreg_zext_lo32_rnd_hi32(struct b=
pf_verifier_env *env,
...
> @@ -164,7 +164,7 @@ static int get_rcw_we(struct rs_control *rs, struct w=
space *ws,
> =20
...
> @@ -178,7 +178,7 @@ static int get_rcw_we(struct rs_control *rs, struct w=
space *ws,
>  	for (i =3D 0; i < errs; i++) {
>  		do {
...
> =20
>  		do {
> @@ -206,7 +206,7 @@ static int get_rcw_we(struct rs_control *rs, struct w=
space *ws,
...
> --- a/mm/shmem.c
> +++ b/mm/shmem.c
> @@ -2330,7 +2330,7 @@ static struct inode *shmem_get_inode(struct super_b=
lock *sb, struct inode *dir,
...
> --- a/mm/slab.c
> +++ b/mm/slab.c
> @@ -2380,7 +2380,7 @@ static bool freelist_state_initialize(union freelis=
t_init_state *state,
>  	unsigned int rand;
> =20
...
> +	delay =3D (u64)msecs_to_jiffies(garp_join_time) * get_random_u32() >> 3=
2;
...
> --- a/net/core/pktgen.c
> +++ b/net/core/pktgen.c
> @@ -2464,7 +2464,7 @@ static void mod_cur_headers(struct pktgen_dev *pkt_=
dev)
...
>  	}
> =20
> @@ -2568,7 +2568,7 @@ static void mod_cur_headers(struct pktgen_dev *pkt_=
dev)
> =20
>  			for (i =3D 0; i < 4; i++) {
...
> --- a/net/ipv4/udp.c
> +++ b/net/ipv4/udp.c
> @@ -246,7 +246,7 @@ int udp_lib_get_port(struct sock *sk, unsigned short =
snum,
...
> @@ -220,7 +220,7 @@ static struct ip6_flowlabel *fl_intern(struct net *ne=
t,
...
> @@ -34,7 +34,7 @@ statistic_mt(const struct sk_buff *skb, struct xt_actio=
n_param *par)
> =20
>  	switch (info->mode) {
...
> @@ -1033,7 +1033,7 @@ static int sample(struct datapath *dp, struct sk_bu=
ff *skb,
...
> --- a/net/rds/bind.c
> +++ b/net/rds/bind.c
> @@ -104,7 +104,7 @@ static int rds_add_bound(struct rds_sock *rs, const s=
truct in6_addr *addr,
>  			return -EINVAL;
>  		last =3D rover;
>  	} else {
...
> @@ -573,7 +573,7 @@ static bool cobalt_should_drop(struct cobalt_vars *va=
rs,
> =20
...
> @@ -171,7 +171,7 @@ static inline struct netem_skb_cb *netem_skb_cb(struc=
t sk_buff *skb)
...
> @@ -268,15 +268,15 @@ static bool loss_gilb_ell(struct netem_sched_data *=
q)
> =20
>  	switch (clg->state) {
>  	case GOOD_STATE:
...
>  	}
> =20
> @@ -632,7 +632,7 @@ static void get_slot_next(struct netem_sched_data *q,=
 u64 now)
> =20
>  	if (!q->slot_dist)
...
kasan-dev/Y0CXxqlowAno279R%40magnolia.
