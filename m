Return-Path: <kasan-dev+bncBC7OBJGL2MHBBOM5UWJQMGQETWXHATQ@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-wr1-x43c.google.com (mail-wr1-x43c.google.com [IPv6:2a00:1450:4864:20::43c])
	by mail.lfdr.de (Postfix) with ESMTPS id 04BBB5118A3
	for <lists+kasan-dev@lfdr.de>; Wed, 27 Apr 2022 16:10:02 +0200 (CEST)
Received: by mail-wr1-x43c.google.com with SMTP id v13-20020adfc5cd000000b0020ad3580cd0sf801944wrg.10
        for <lists+kasan-dev@lfdr.de>; Wed, 27 Apr 2022 07:10:02 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1651068601; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        bh=ljUQ/jwlhUqApAC/nM553PnJQJ54dXKA4NQRa0zaYi8=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@google.com header.s=20210112 header.b=aCZ+UQqy;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ljUQ/jwlhUqApAC/nM553PnJQJ54dXKA4NQRa0zaYi8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ljUQ/jwlhUqApAC/nM553PnJQJ54dXKA4NQRa0zaYi8=;
        b=
X-Gm-Message-State: AOAM5331/U/W7xaGFODFUugDDeYzSVxYO3MIe52kcRsFasDXNgW0Qjr5
	E6nXKqsxIMfcyotknAO8FMg=
X-Google-Smtp-Source: ABdhPJzZzulzm/txl5Epqjc90kauZO4UMGOe6C9JZ9Syd9+poE4BoepuBDCFhAPpIjMQh/KZpxMXgg==
X-Received: by 2002:a7b:cb83:0:b0:37e:bc50:3c6b with SMTP id m3-20020a7bcb83000000b0037ebc503c6bmr36181621wmi.67.1651068601417;
        Wed, 27 Apr 2022 07:10:01 -0700 (PDT)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a5d:6d84:0:b0:20a:eafa:40fb with SMTP id l4-20020a5d6d84000000b0020aeafa40fbls3646339wrs.3.gmail;
 Wed, 27 Apr 2022 07:10:00 -0700 (PDT)
X-Received: by 2002:adf:e891:0:b0:20a:d653:7cd2 with SMTP id d17-20020adfe891000000b0020ad6537cd2mr15721254wrm.195.1651068599981;
        Wed, 27 Apr 2022 07:09:59 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1651068599; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        b=
...
Received: from mail-wr1-x433.google.com (mail-wr1-x433.google.com. [2a00:1450:4864:20::433])
        by gmr-mx.google.com with ESMTPS id d10-20020a05600c34ca00b00393ed6e46d8si115755wmq.2.2022.04.27.07.09.59
...
Received: by mail-wr1-x433.google.com with SMTP id s21so2667953wrb.8
        for <kasan-dev@googlegroups.com>; Wed, 27 Apr 2022 07:09:59 -0700 (PDT)
...
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@google.com header.s=20210112 header.b=aCZ+UQqy;       spf=pass
...
> +	def_bool (CC_IS_CLANG && $(cc-option,-fsanitize=3Dkernel-memory -mllvm =
-msan-disable-checks=3D1))
> +
> +config KMSAN
...
> +	 * dst_slots =3D=3D src_slots + 1), there is an extra origin slot at th=
e
...
> +		 */
> +		if (checked) {
> +			pr_err("%s: not memsetting %ld bytes starting at %px, because the sha=
dow is NULL\n",
> +			       __func__, size, addr);
> +			KMSAN_WARN_ON(true);
> +		}
...
> +
> +/*
> + * When a compiler hook is invoked, it may make a call to instrumented c=
ode
> + * and eventually call itself recursively. To avoid that, we protect the
> + * runtime entry points with kmsan_enter_runtime()/kmsan_leave_runtime()=
 and
...
> +
> +/*
> + * Taken from arch/x86/mm/physaddr.h to avoid using an instrumented vers=
ion.
> + */
...
> +
> +/*
> + * Taken from arch/x86/mm/physaddr.c to avoid using an instrumented vers=
ion.
> + */
...
kasan-dev/YmlOrxYCbAnVrV7r%40elver.google.com.
