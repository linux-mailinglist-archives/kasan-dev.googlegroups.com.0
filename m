Return-Path: <kasan-dev+bncBD2KV7O4UQOBBCW23CNAMGQEWFOELJY@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-ed1-x537.google.com (mail-ed1-x537.google.com [IPv6:2a00:1450:4864:20::537])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A73E609A46
	for <lists+kasan-dev@lfdr.de>; Mon, 24 Oct 2022 08:13:31 +0200 (CEST)
Received: by mail-ed1-x537.google.com with SMTP id i17-20020a05640242d100b0044f18a5379asf8572016edc.21
        for <lists+kasan-dev@lfdr.de>; Sun, 23 Oct 2022 23:13:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=OKwUBLbgNMaiZs0t3t3K4sPHJem4pIf+SLe8AV5P4WQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         ...
         :user-agent:in-reply-to:content-disposition:message-id:subject:cc:to
         :from:date:x-gm-message-state:sender:from:to:cc:subject:date
         :message-id:reply-to;
        bh=OKwUBLbgNMaiZs0t3t3K4sPHJem4pIf+SLe8AV5P4WQ=;
        b=
Sender: kasan-dev@googlegroups.com
X-Gm-Message-State: ACrzQf2f75e4u92lc3One4WgyXPj4n7FBRa7P2eRImiIN9/FV873EQyF
	oHm5qRfzhyK054XbsaWiGLg=
X-Google-Smtp-Source: AMsMyM6gHZ1nIW7WZAI/J1IBVnrfJmhLQOqcx9pik++e8IqRj88Ij8yLTKBnSeOANCzpbolokI6J/g==
X-Received: by 2002:a17:907:97c7:b0:7a5:ad82:f31c with SMTP id js7-20020a17090797c700b007a5ad82f31cmr4839130ejc.497.1666592010942;
        Sun, 23 Oct 2022 23:13:30 -0700 (PDT)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a05:6402:26d0:b0:45c:bfd9:fb45 with SMTP id
 x16-20020a05640226d000b0045cbfd9fb45ls7922167edd.3.-pod-prod-gmail; Sun, 23
 Oct 2022 23:13:29 -0700 (PDT)
X-Received: by 2002:a05:6402:344:b0:461:7d4:9c9 with SMTP id r4-20020a056402034400b0046107d409c9mr18982892edw.141.1666592009441;
        Sun, 23 Oct 2022 23:13:29 -0700 (PDT)
Received: from mga04.intel.com (mga04.intel.com. [192.55.52.120])
        by gmr-mx.google.com with ESMTPS id gv25-20020a1709072bd900b007a448e165e7si94688ejc.2.2022.10.23.23.13.28
...
X-IronPort-AV: E=McAfee;i="6500,9779,10509"; a="306078051"
X-IronPort-AV: E=Sophos;i="5.95,207,1661842800"; 
   d="xz'?scan'208";a="306078051"
...
CC: <lkp@lists.01.org>, <lkp@intel.com>, Dmitry Vyukov <dvyukov@google.com>,
	Jakub Kicinski <kuba@kernel.org>, Paolo Abeni <pabeni@redhat.com>, "Christoph
 ...
 Ryabinin" <ryabinin.a.a@gmail.com>, Alexander Potapenko <glider@google.com>,
	Andrey Konovalov <andreyknvl@gmail.com>, Vincenzo Frascino
...
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@intel.com header.s=Intel header.b=RsgtSYA6;       arc=fail (body
 hash mismatch);       spf=pass (google.com: domain of oliver.sang@intel.com
 designates 192.55.52.120 as permitted sender) smtp.mailfrom=oliver.sang@intel.com;
...
FYI, we noticed BUG:KASAN:slab-out-of-bounds_in_copy_array due to commit (b=
uilt with gcc-11):

commit: d916d97f33952312ca6b8240b40ed79cc9cb04b2 ("[PATCH] mm: Make ksize()=
 a reporting-only function")
url: https://github.com/intel-lab-lkp/linux/commits/Kees-Cook/mm-Make-ksize=
-a-reporting-only-function/20221023-020908
base: https://git.kernel.org/cgit/linux/kernel/git/akpm/mm.git mm-everythin=
g
patch link: https://lore.kernel.org/linux-mm/20221022180455.never.023-kees@=
kernel.org
...
| Link: https://lore.kernel.org/r/202210241317.54083ce6-oliver.sang@intel.c=
om


[ 32.059131][ T1] BUG: KASAN: slab-out-of-bounds in copy_array (kbuild/src/=
x86_64-3/arch/x86/kernel/cpu/hypervisor.c:91)=20
[   32.059705][    T1] Write of size 32 at addr ffff88814b9d75c0 by task sy=
stemd/1
[   32.060330][    T1]
[   32.060576][    T1] CPU: 1 PID: 1 Comm: systemd Not tainted 6.1.0-rc1-00=
216-gd916d97f3395 #2
[   32.061273][    T1] Hardware name: QEMU Standard PC (i440FX + PIIX, 1996=
), BIOS 1.16.0-debian-1.16.0-4 04/01/2014
[   32.062082][    T1] Call Trace:
[   32.062393][    T1]  <TASK>
[ 32.062680][ T1] dump_stack_lvl (kbuild/src/x86_64-3/lib/dump_stack.c:107 =
(discriminator 4))=20
[ 32.063071][ T1] print_address_description+0x87/0x2a5=20
[ 32.063609][ T1] print_report (kbuild/src/x86_64-3/mm/kasan/report.c:365)=
=20
[ 32.064003][ T1] ? kasan_addr_to_slab (kbuild/src/x86_64-3/mm/kasan/common=
.c:35)=20
[ 32.064424][ T1] ? copy_array (kbuild/src/x86_64-3/arch/x86/kernel/cpu/hyp=
ervisor.c:91)=20
[ 32.064801][ T1] kasan_report (kbuild/src/x86_64-3/mm/kasan/report.c:131 k=
build/src/x86_64-3/mm/kasan/report.c:466)=20
[ 32.065188][ T1] ? copy_array (kbuild/src/x86_64-3/arch/x86/kernel/cpu/hyp=
ervisor.c:91)=20
[ 32.065570][ T1] kasan_check_range (kbuild/src/x86_64-3/mm/kasan/generic.c=
:190)=20
[ 32.065986][ T1] memcpy (kbuild/src/x86_64-3/mm/kasan/shadow.c:65 (discrim=
inator 1))=20
[ 32.066333][ T1] copy_array (kbuild/src/x86_64-3/arch/x86/kernel/cpu/hyper=
visor.c:91)=20
[ 32.066699][ T1] copy_verifier_state (kbuild/src/x86_64-3/kernel/bpf/verif=
ier.c:1189)=20
...
[ 32.067878][ T1] ? lock_downgrade (kbuild/src/x86_64-3/kernel/locking/lock=
dep.c:5320)=20
[ 32.068294][ T1] ? check_helper_call (kbuild/src/x86_64-3/kernel/bpf/verif=
ier.c:12144)=20
[ 32.068737][ T1] ? kasan_quarantine_put (kbuild/src/x86_64-3/arch/x86/incl=
ude/asm/irqflags.h:45 (discriminator 1) kbuild/src/x86_64-3/arch/x86/includ=
e/asm/irqflags.h:80 (discriminator 1) kbuild/src/x86_64-3/arch/x86/include/=
asm/irqflags.h:138 (discriminator 1) kbuild/src/x86_64-3/mm/kasan/quarantin=
e.c:242 (discriminator 1))=20
[ 32.069181][ T1] ? trace_hardirqs_on (kbuild/src/x86_64-3/kernel/trace/tra=
ce_preemptirq.c:50 (discriminator 22))=20
[ 32.069605][ T1] ? memset (kbuild/src/x86_64-3/mm/kasan/shadow.c:44)=20
[ 32.069960][ T1] ? memset (kbuild/src/x86_64-3/mm/kasan/shadow.c:44)=20
[ 32.070317][ T1] ? memset (kbuild/src/x86_64-3/mm/kasan/shadow.c:44)=20
[ 32.070683][ T1] do_check_common (kbuild/src/x86_64-3/kernel/bpf/verifier.=
c:14642)=20
[ 32.071088][ T1] ? check_cfg (kbuild/src/x86_64-3/kernel/bpf/verifier.c:10=
938)=20
[ 32.071483][ T1] bpf_check (kbuild/src/x86_64-3/kernel/bpf/verifier.c:1470=
5 kbuild/src/x86_64-3/kernel/bpf/verifier.c:15275)=20
[ 32.071869][ T1] ? find_held_lock (kbuild/src/x86_64-3/kernel/locking/lock=
dep.c:5158)=20
[ 32.072279][ T1] ? bpf_prog_load (kbuild/src/x86_64-3/kernel/bpf/syscall.c=
:2598)=20
[ 32.072696][ T1] ? bpf_get_btf_vmlinux (kbuild/src/x86_64-3/kernel/bpf/ver=
ifier.c:15159)=20
[ 32.073124][ T1] ? lockdep_hardirqs_on_prepare (kbuild/src/x86_64-3/kernel=
/locking/lockdep.c:4528)=20
[ 32.073647][ T1] ? memset (kbuild/src/x86_64-3/mm/kasan/shadow.c:44)=20
[ 32.074006][ T1] bpf_prog_load (kbuild/src/x86_64-3/kernel/bpf/syscall.c:2=
605)=20
[ 32.074412][ T1] ? bpf_prog_bind_map (kbuild/src/x86_64-3/kernel/bpf/sysca=
ll.c:2464)=20
[ 32.074839][ T1] ? lock_acquire (kbuild/src/x86_64-3/kernel/locking/lockde=
p.c:466 kbuild/src/x86_64-3/kernel/locking/lockdep.c:5670 kbuild/src/x86_64=
-3/kernel/locking/lockdep.c:5633)=20
[ 32.075244][ T1] ? __might_fault (kbuild/src/x86_64-3/mm/memory.c:5645 kbu=
ild/src/x86_64-3/mm/memory.c:5638)=20
[ 32.075654][ T1] ? lock_downgrade (kbuild/src/x86_64-3/kernel/locking/lock=
dep.c:5320)=20
[ 32.076067][ T1] ? lock_is_held_type (kbuild/src/x86_64-3/kernel/locking/l=
ockdep.c:5409 kbuild/src/x86_64-3/kernel/locking/lockdep.c:5711)=20
[ 32.076489][ T1] ? __might_fault (kbuild/src/x86_64-3/mm/memory.c:5645 kbu=
ild/src/x86_64-3/mm/memory.c:5638)=20
[ 32.076887][ T1] ? lock_release (kbuild/src/x86_64-3/kernel/locking/lockde=
p.c:466 kbuild/src/x86_64-3/kernel/locking/lockdep.c:5690)=20
[ 32.077284][ T1] __sys_bpf (kbuild/src/x86_64-3/kernel/bpf/syscall.c:4965)=
=20
[ 32.077662][ T1] ? link_create (kbuild/src/x86_64-3/kernel/bpf/syscall.c:4=
912)=20
[ 32.078055][ T1] ? trace_hardirqs_on (kbuild/src/x86_64-3/kernel/trace/tra=
ce_preemptirq.c:50 (discriminator 22))=20
[ 32.079667][ T1] ? task_work_run (kbuild/src/x86_64-3/kernel/task_work.c:1=
82 (discriminator 1))=20
[ 32.080090][ T1] __ia32_sys_bpf (kbuild/src/x86_64-3/kernel/bpf/syscall.c:=
5067)=20
[ 32.080483][ T1] __do_fast_syscall_32 (kbuild/src/x86_64-3/arch/x86/entry/=
common.c:112 kbuild/src/x86_64-3/arch/x86/entry/common.c:178)=20
[ 32.080911][ T1] ? lockdep_hardirqs_on_prepare (kbuild/src/x86_64-3/kernel=
/locking/lockdep.c:4528)=20
[ 32.081432][ T1] ? __do_fast_syscall_32 (kbuild/src/x86_64-3/arch/x86/entr=
y/common.c:183)=20
[ 32.081869][ T1] ? __do_fast_syscall_32 (kbuild/src/x86_64-3/arch/x86/entr=
y/common.c:183)=20
[ 32.082310][ T1] ? lockdep_hardirqs_on_prepare (kbuild/src/x86_64-3/kernel=
/locking/lockdep.c:4528)=20
[ 32.082836][ T1] ? __do_fast_syscall_32 (kbuild/src/x86_64-3/arch/x86/entr=
y/common.c:183)=20
[ 32.083292][ T1] do_fast_syscall_32 (kbuild/src/x86_64-3/arch/x86/entry/co=
mmon.c:203)=20
[ 32.083709][ T1] entry_SYSENTER_compat_after_hwframe (kbuild/src/x86_64-3/=
arch/x86/entry/entry_64_compat.S:122)=20
[   32.084213][    T1] RIP: 0023:0xf7fb6549
[ 32.084574][ T1] Code: 03 74 c0 01 10 05 03 74 b8 01 10 06 03 74 b4 01 10 =
...
[   32.086028][    T1] RSP: 002b:00000000ffdde7dc EFLAGS: 00200206 ORIG_RAX=
: 0000000000000165
[   32.086706][    T1] RAX: ffffffffffffffda RBX: 0000000000000005 RCX: 000=
00000ffdde818
[   32.087375][    T1] RDX: 0000000000000070 RSI: 000000005805ebe0 RDI: 000=
0000000000000
[   32.088030][    T1] RBP: 000000000000000f R08: 0000000000000000 R09: 000=
0000000000000
[   32.088688][    T1] R10: 0000000000000000 R11: 0000000000200206 R12: 000=
0000000000000
[   32.089341][    T1] R13: 0000000000000000 R14: 0000000000000000 R15: 000=
0000000000000
[   32.090006][    T1]  </TASK>
[   32.090303][    T1]
[   32.090550][    T1] Allocated by task 1:
[ 32.090908][ T1] kasan_save_stack (kbuild/src/x86_64-3/mm/kasan/common.c:4=
6)=20
[ 32.091316][ T1] kasan_set_track (kbuild/src/x86_64-3/mm/kasan/common.c:52=
)=20
[ 32.091717][ T1] __kasan_krealloc (kbuild/src/x86_64-3/mm/kasan/common.c:4=
40)=20
[ 32.092131][ T1] krealloc (kbuild/src/x86_64-3/include/linux/kasan.h:231 k=
build/src/x86_64-3/mm/slab_common.c:1346 kbuild/src/x86_64-3/mm/slab_common=
.c:1383)=20
[ 32.092490][ T1] is_state_visited (kbuild/src/x86_64-3/kernel/bpf/verifier=
.c:2505 kbuild/src/x86_64-3/kernel/bpf/verifier.c:11982)=20
[ 32.092912][ T1] do_check (kbuild/src/x86_64-3/kernel/bpf/verifier.c:12176=
)=20
[ 32.093285][ T1] do_check_common (kbuild/src/x86_64-3/kernel/bpf/verifier.=
c:14642)=20
[ 32.093692][ T1] bpf_check (kbuild/src/x86_64-3/kernel/bpf/verifier.c:1470=
5 kbuild/src/x86_64-3/kernel/bpf/verifier.c:15275)=20
[ 32.094074][ T1] bpf_prog_load (kbuild/src/x86_64-3/kernel/bpf/syscall.c:2=
605)=20
[ 32.094473][ T1] __sys_bpf (kbuild/src/x86_64-3/kernel/bpf/syscall.c:4965)=
=20
[ 32.094851][ T1] __ia32_sys_bpf (kbuild/src/x86_64-3/kernel/bpf/syscall.c:=
5067)=20
[ 32.095246][ T1] __do_fast_syscall_32 (kbuild/src/x86_64-3/arch/x86/entry/=
common.c:112 kbuild/src/x86_64-3/arch/x86/entry/common.c:178)=20
[ 32.095674][ T1] do_fast_syscall_32 (kbuild/src/x86_64-3/arch/x86/entry/co=
mmon.c:203)=20
[ 32.096084][ T1] entry_SYSENTER_compat_after_hwframe (kbuild/src/x86_64-3/=
arch/x86/entry/entry_64_compat.S:122)=20
[   32.096593][    T1]
[   32.096840][    T1] The buggy address belongs to the object at ffff88814=
b9d75c0
...
[   32.099656][    T1] page:00000000a3d33dcb refcount:1 mapcount:0 mapping:=
0000000000000000 index:0x0 pfn:0x14b9d7
[   32.100459][    T1] flags: 0x17ffffc0000200(slab|node=3D0|zone=3D2|lastc=
pupid=3D0x1fffff)
[   32.101113][    T1] raw: 0017ffffc0000200 0000000000000000 dead000000000=
122 ffff888100041500
[   32.101813][    T1] raw: 0000000000000000 0000000080400040 00000001fffff=
...
[   32.103496][    T1] page last allocated via order 0, migratetype Unmovab=
le, gfp_mask 0x112cc0(GFP_USER|__GFP_NOWARN|__GFP_NORETRY), pid 1, tgid 1 (=
systemd), ts 32049485962, free_ts 0
[ 32.104752][ T1] get_page_from_freelist (kbuild/src/x86_64-3/mm/page_alloc=
.c:2549 kbuild/src/x86_64-3/mm/page_alloc.c:4287)=20
[ 32.105197][ T1] __alloc_pages (kbuild/src/x86_64-3/mm/page_alloc.c:5547)=
=20
[ 32.105592][ T1] allocate_slab (kbuild/src/x86_64-3/mm/slub.c:1794 kbuild/=
src/x86_64-3/mm/slub.c:1939)=20
[ 32.105988][ T1] ___slab_alloc (kbuild/src/x86_64-3/mm/slub.c:3180)=20
[ 32.106385][ T1] __kmem_cache_alloc_node (kbuild/src/x86_64-3/mm/slub.c:32=
79 kbuild/src/x86_64-3/mm/slub.c:3364 kbuild/src/x86_64-3/mm/slub.c:3437)=
=20
[ 32.106832][ T1] __kmalloc_node_track_caller (kbuild/src/x86_64-3/include/=
linux/kasan.h:211 kbuild/src/x86_64-3/mm/slab_common.c:955 kbuild/src/x86_6=
4-3/mm/slab_common.c:975)=20
[ 32.107304][ T1] copy_array (kbuild/src/x86_64-3/arch/x86/kernel/cpu/hyper=
visor.c:93)=20
[ 32.107672][ T1] copy_verifier_state (kbuild/src/x86_64-3/kernel/bpf/verif=
ier.c:1189)=20
[ 32.108094][ T1] push_stack (kbuild/src/x86_64-3/kernel/bpf/verifier.c:128=
8)=20
[ 32.108466][ T1] check_cond_jmp_op (kbuild/src/x86_64-3/kernel/bpf/verifie=
r.c:10223)=20
[ 32.108884][ T1] do_check (kbuild/src/x86_64-3/kernel/bpf/verifier.c:12451=
)=20
[ 32.109259][ T1] do_check_common (kbuild/src/x86_64-3/kernel/bpf/verifier.=
c:14642)=20
[ 32.109663][ T1] bpf_check (kbuild/src/x86_64-3/kernel/bpf/verifier.c:1470=
5 kbuild/src/x86_64-3/kernel/bpf/verifier.c:15275)=20
[ 32.110044][ T1] bpf_prog_load (kbuild/src/x86_64-3/kernel/bpf/syscall.c:2=
605)=20
[ 32.110442][ T1] __sys_bpf (kbuild/src/x86_64-3/kernel/bpf/syscall.c:4965)=
=20
[ 32.110815][ T1] __ia32_sys_bpf (kbuild/src/x86_64-3/kernel/bpf/syscall.c:=
5067)=20
...
kasan-dev/202210241317.54083ce6-oliver.sang%40intel.com.
