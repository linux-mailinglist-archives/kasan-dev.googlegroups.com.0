Return-Path: <kasan-dev+bncBDZ2VWGKUYCBB4PJT65QMGQEJAG6WUI@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-qt1-x83b.google.com (mail-qt1-x83b.google.com [IPv6:2607:f8b0:4864:20::83b])
	by mail.lfdr.de (Postfix) with ESMTPS id 487599FA560
	for <lists+kasan-dev@lfdr.de>; Sun, 22 Dec 2024 12:16:03 +0100 (CET)
Received: by mail-qt1-x83b.google.com with SMTP id d75a77b69052e-46798d74f0csf62923571cf.0
        for <lists+kasan-dev@lfdr.de>; Sun, 22 Dec 2024 03:16:03 -0800 (PST)
ARC-Seal: i=2; a=rsa-sha256; t=1734866162; cv=pass;
        d=google.com; s=arc-20240605;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20240605;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:mime-version:message-id:date
         :subject:cc:to:from:sender:dkim-signature:dkim-signature;
        bh=prYe2TSvx4a19rlKKUZ+auERWUXdypcuuIkGs1/A/k0=;
        fh=BQfR0YHNJVwYWrPocHraWCzceIcFhbK8EP1bIu5rc54=;
        b=;
        darn=lfdr.de
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@gmail.com header.s=20230601 header.b=QlRIocRI;
       spf=pass (google.com: domain of guoweikang.kernel@gmail.com designates 2607:f8b0:4864:20::433 as permitted sender) smtp.mailfrom=guoweikang.kernel@gmail.com;
       dmarc=pass (p=NONE sp=QUARANTINE dis=NONE) header.from=gmail.com;
       dara=pass header.i=@googlegroups.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=googlegroups.com; s=20230601; t=1734866162; x=1735470962; darn=lfdr.de;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:x-original-authentication-results
         :x-original-sender:mime-version:message-id:date:subject:cc:to:from
         :sender:from:to:cc:subject:date:message-id:reply-to;
        bh=prYe2TSvx4a19rlKKUZ+auERWUXdypcuuIkGs1/A/k0=;
        b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1734866162; x=1735470962; darn=lfdr.de;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:x-original-authentication-results
         :x-original-sender:mime-version:message-id:date:subject:cc:to:from
         :from:to:cc:subject:date:message-id:reply-to;
        bh=prYe2TSvx4a19rlKKUZ+auERWUXdypcuuIkGs1/A/k0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1734866162; x=1735470962;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         ...
         :sender:from:to:cc:subject:date:message-id:reply-to;
        bh=prYe2TSvx4a19rlKKUZ+auERWUXdypcuuIkGs1/A/k0=;
        b=
Sender: kasan-dev@googlegroups.com
X-Forwarded-Encrypted: i=2; AJvYcCVjGYmIwYsrETGqpB2qezFok1G9hck4BFDO+3gSJRTSt7ZPXpTutMC56KuX/pr4AyLRdlQnlQ==@lfdr.de
X-Gm-Message-State: AOJu0Ywgc5kZUvZK+HGwzBk6/u/4XnEwKPQj0snyB+dhUJ7JyLzTT9ZR
	Qi+chv5c92ETe6YzaEdaoyHnTfiYA5Avb+wiuVeTqSTqhuwBKuTp
X-Google-Smtp-Source: AGHT+IERhvUtnfL/mxanEhLgT+X5STEdOpYrvpbgGfwQZtGjvTRG3CBy3+fFuvdsTynBW3kmRJoZCQ==
X-Received: by 2002:a05:622a:11d1:b0:466:8a95:d1cc with SMTP id d75a77b69052e-46a4a991a43mr129011041cf.47.1734866161828;
        Sun, 22 Dec 2024 03:16:01 -0800 (PST)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a05:622a:251b:b0:466:9e59:9807 with SMTP id
 d75a77b69052e-46a3b15d06cls73483371cf.1.-pod-prod-05-us; Sun, 22 Dec 2024
 03:16:01 -0800 (PST)
X-Forwarded-Encrypted: i=2; AJvYcCUvjKLDoLf69t55QSrrP2eQR4rbt5u6ZEIfnp7oUmX8fmJ/+1eXsnqVKEtsaarUpZk4KMT+2ynIzBc=@googlegroups.com
X-Received: by 2002:a05:620a:2611:b0:7b1:492c:ba83 with SMTP id af79cd13be357-7b9ba716a60mr1764438485a.10.1734866160971;
        Sun, 22 Dec 2024 03:16:00 -0800 (PST)
ARC-Seal: i=1; a=rsa-sha256; t=1734866160; cv=none;
        d=google.com; s=arc-20240605;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20240605;
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         :to:from:dkim-signature;
        bh=SeC6bQQxdK8aBJy4uBC70oPQwV/BtqL8fR6Vi5GDB30=;
        fh=brkLoSATOkvTRNEa0LvcQCUvj57fPem9bVq4krs12i4=;
        b=;
        dara=google.com
...
Received: from mail-pf1-x433.google.com (mail-pf1-x433.google.com. [2607:f8b0:4864:20::433])
        by gmr-mx.google.com with ESMTPS id af79cd13be357-7b9ac469028si30003785a.3.2024.12.22.03.16.00
        for <kasan-dev@googlegroups.com>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 22 Dec 2024 03:16:00 -0800 (PST)
Received-SPF: pass (google.com: domain of guoweikang.kernel@gmail.com designates 2607:f8b0:4864:20::433 as permitted sender) client-ip=2607:f8b0:4864:20::433;
Received: by mail-pf1-x433.google.com with SMTP id d2e1a72fcca58-725f2f79ed9so2659025b3a.2
        for <kasan-dev@googlegroups.com>; Sun, 22 Dec 2024 03:16:00 -0800 (PST)
X-Forwarded-Encrypted: i=1; AJvYcCVLopZTeS7WzBNaaSiFy3IT4L0OIoxfeUBtH7L/aklB6Wt8fGlri1LrRyue5ejYbJmr9svVNUMZ1JM=@googlegroups.com
X-Gm-Gg: 
	YvKY
...
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@gmail.com header.s=20230601 header.b=QlRIocRI;       spf=pass
 (google.com: domain of guoweikang.kernel@gmail.com designates
 2607:f8b0:4864:20::433 as permitted sender) smtp.mailfrom=guoweikang.kernel@gmail.com;
       dmarc=pass (p=NONE sp=QUARANTINE dis=NONE) header.from=gmail.com;
       dara=pass header.i=@googlegroups.com
...
To view this discussion visit https://groups.google.com/d/msgid/kasan-dev/20241222111537.2720303-1-guoweikang.kernel%40gmail.com.
