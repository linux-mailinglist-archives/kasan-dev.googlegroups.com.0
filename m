Return-Path: <kasan-dev+bncBD2OL34CV4HBBL5QS2YAMGQEKD724XQ@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-lf1-x140.google.com (mail-lf1-x140.google.com [IPv6:2a00:1450:4864:20::140])
	by mail.lfdr.de (Postfix) with ESMTPS id EFFF08904C6
	for <lists+kasan-dev@lfdr.de>; Thu, 28 Mar 2024 17:17:53 +0100 (CET)
Received: by mail-lf1-x140.google.com with SMTP id 2adb3069b0e04-515bf7983f6sf16848e87.0
        for <lists+kasan-dev@lfdr.de>; Thu, 28 Mar 2024 09:17:53 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1711642673; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        bh=NfN8ku5YEllcU0e2cBcPE/pG//6A3sMowZrnQqwGOAE=;
        fh=v6zz297jhjDpkiCxXuOellI9EDP0LTVjLIGjgV+hWy0=;
        b=;
        darn=lfdr.de
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=googlegroups.com; s=20230601; t=1711642673; x=1712247473; darn=lfdr.de;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
        ...
        bh=NfN8ku5YEllcU0e2cBcPE/pG//6A3sMowZrnQqwGOAE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1711642673; x=1712247473;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
        ...
        bh=NfN8ku5YEllcU0e2cBcPE/pG//6A3sMowZrnQqwGOAE=;
        b=
Sender: kasan-dev@googlegroups.com
X-Forwarded-Encrypted: i=2; AJvYcCWQz0Sxm+/q8Qvi5/p0/jqaRjADw3o/KqeVocYw77GnjvFvYoXkVFv+LBwb8s6Q5euMwRomv9VuCYDCZ2ZDbPB7ihjBTTnHSA==
X-Gm-Message-State: AOJu0YwAn3sGpL0euB5QMtPu9WEWnIhqAM2Sc3UToMEiAydSvLH4bBLH
	BRWcnX5Jl3ktY6XkyPiV450YUP2zuIrmh8X+3cbQTP4b+JEKQAe3
X-Google-Smtp-Source: AGHT+IH5minli7WYolwbDxnsj+wSp741h8cisXio/ATc1C0OEoaehxcVCoWUgLAKLxMBCLUxAotQEQ==
X-Received: by 2002:ac2:4dab:0:b0:515:c2ad:6cac with SMTP id h11-20020ac24dab000000b00515c2ad6cacmr128302lfe.7.1711642672019;
        Thu, 28 Mar 2024 09:17:52 -0700 (PDT)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a05:6512:1391:b0:515:b137:ffe0 with SMTP id
 fc17-20020a056512139100b00515b137ffe0ls606874lfb.1.-pod-prod-01-eu; Thu, 28
 Mar 2024 09:17:50 -0700 (PDT)
X-Received: by 2002:a05:6512:714:b0:515:a799:604e with SMTP id b20-20020a056512071400b00515a799604emr1861491lfs.41.1711642669574;
        Thu, 28 Mar 2024 09:17:49 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1711642669; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=in-reply-to:content-language:references:cc:to:from:subject
         :user-agent:mime-version:date:message-id;
        bh=ib725/V58ND+LCKDfeytryBSYOklgkpqR9ooSk5rk9s=;
        fh=cGeuCYcpo0sb7GsL/Y46jyTPIFVNaqHc/0lAAbP3BJg=;
        b=;
        dara=google.com
ARC-Authentication-Results: i=1; gmr-mx.google.com;
       spf=pass (google.com: domain of pmenzel@molgen.mpg.de designates 141.14.17.11 as permitted sender) smtp.mailfrom=pmenzel@molgen.mpg.de
Received: from mx3.molgen.mpg.de (mx3.molgen.mpg.de. [141.14.17.11])
        by gmr-mx.google.com with ESMTPS id o13-20020a056512052d00b00513d22b003bsi52613lfc.11.2024.03.28.09.17.49
...
>>> Trying KCSAN the first time =E2=80=93 configuration attached =E2=80=93,=
 it fails to boot
>>> on the Dell XPS 13 9360 and QEMU q35. I couldn=E2=80=99t get logs on th=
e Dell
...
> laptop hangs the laptop right away. I couldn=E2=80=99t get any logs of th=
e laptop.

In the QEMU q35 virtual machine `echo on | sudo tee=20
/sys/kernel/debug/kcsan` also locks up the system. Please find the logs=20
attached.

     [   78.241245] BUG: unable to handle page fault for address:=20
0000000000019a18
     ...
     [   78.248289] Hardware name: QEMU Standard PC (Q35 + ICH9, 2009),=20
BIOS rel-1.16.1-0-g3208b098f51a-prebuilt.qemu.org 04/01/2014
     [   78.250763] RIP: 0010:kcsan_setup_watchpoint+0x2b3/0x400
     [   78.252108] Code: ea 00 f0 48 ff 05 25 b4 8f 02 eb e0 65 48 8b=20
05 7b 53 23 4f 48 8d 98 c0 02 03 00 e9 9f fd ff ff 48 83 fd 08 0f 85 fd=20
00 00 00 <4d> 8b 04 24 e9 bf fe ff ff 49 85 d1 75 54 ba 01 00 00 00 4a 84
     ...
     [   78.257548] RAX: 0000000000000000 RBX: ffff9b95c4ba93b0 RCX:=20
0000000000000019
     [   78.259158] RDX: 0000000000000001 RSI: ffffffffb0f82d36 RDI:=20
0000000000000000
     [   78.260781] RBP: 0000000000000008 R08: 00000000aaaaaaab R09:=20
0000000000000000
     [   78.262417] R10: 0000000000000086 R11: 0010000000019a18 R12:=20
0000000000019a18
     [   78.264040] R13: 000000000000001a R14: 0000000000000000 R15:=20
0000000000000000
     [   78.265658] FS:  00007f65e3a91f00(0000)=20
GS:ffff9b9d1f000000(0000) knlGS:0000000000000000
     [   78.267480] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
     [   78.268804] CR2: 0000000000019a18 CR3: 0000000102e26000 CR4:=20
00000000003506f0
...
>>> ```
>>> $ qemu-system-x86_64 -M q35 -enable-kvm -smp cpus=3D2 -m 1G -serial=20
>>> stdio -net nic -net user,hostfwd=3Dtcp::22222-:22 -kernel=20
>>> boot/vmlinuz-6.9.0-rc1+ -append "root=3D/dev/sda1 console=3DttyS0"
>>> [=C2=A0=C2=A0=C2=A0 0.000000] Linux version 6.9.0-rc1+ (build@bohemianr=
hapsody.molgen.mpg.de) (gcc (Debian 13.2.0-19) 13.2.0, GNU ld (GNU Binutils=
 for Debian) 2.42) #75 SMP PREEMPT_DYNAMIC Tue Mar 26 07:03:41 CET 2024
>>> [=C2=A0=C2=A0=C2=A0 0.000000] Command line: root=3D/dev/sda1 console=3D=
ttyS0
>>> [=C2=A0=C2=A0=C2=A0 0.000000] BIOS-provided physical RAM map:
>>> [=C2=A0=C2=A0=C2=A0 0.000000] BIOS-e820: [mem 0x0000000000000000-0x0000=
00000009fbff] usable
>>> [=C2=A0=C2=A0=C2=A0 0.000000] BIOS-e820: [mem 0x000000000009fc00-0x0000=
00000009ffff] reserved
>>> [=C2=A0=C2=A0=C2=A0 0.000000] BIOS-e820: [mem 0x00000000000f0000-0x0000=
0000000fffff] reserved
>>> [=C2=A0=C2=A0=C2=A0 0.000000] BIOS-e820: [mem 0x0000000000100000-0x0000=
00003ffdefff] usable
>>> [=C2=A0=C2=A0=C2=A0 0.000000] BIOS-e820: [mem 0x000000003ffdf000-0x0000=
00003fffffff] reserved
>>> [=C2=A0=C2=A0=C2=A0 0.000000] BIOS-e820: [mem 0x00000000b0000000-0x0000=
0000bfffffff] reserved
>>> [=C2=A0=C2=A0=C2=A0 0.000000] BIOS-e820: [mem 0x00000000fed1c000-0x0000=
0000fed1ffff] reserved
>>> [=C2=A0=C2=A0=C2=A0 0.000000] BIOS-e820: [mem 0x00000000feffc000-0x0000=
0000feffffff] reserved
>>> [=C2=A0=C2=A0=C2=A0 0.000000] BIOS-e820: [mem 0x00000000fffc0000-0x0000=
0000ffffffff] reserved
>>> [=C2=A0=C2=A0=C2=A0 0.000000] NX (Execute Disable) protection: active
>>> [=C2=A0=C2=A0=C2=A0 0.000000] APIC: Static calls initialized
>>> [=C2=A0=C2=A0=C2=A0 0.000000] SMBIOS 3.0.0 present.
>>> [=C2=A0=C2=A0=C2=A0 0.000000] DMI: QEMU Standard PC (Q35 + ICH9, 2009),=
 BIOS 1.16.3-debian-1.16.3-2 04/01/2014
>>> [=C2=A0=C2=A0=C2=A0 0.000000] Hypervisor detected: KVM
>>> [=C2=A0=C2=A0=C2=A0 0.000000] kvm-clock: Using msrs 4b564d01 and 4b564d=
00
>>> [=C2=A0=C2=A0=C2=A0 0.000001] kvm-clock: using sched offset of 13769809=
56 cycles
>>> [=C2=A0=C2=A0=C2=A0 0.000006] clocksource: kvm-clock: mask: 0xfffffffff=
fffffff max_cycles: 0x1cd42e4dffb, max_idle_ns: 881590591483 ns
>>> [=C2=A0=C2=A0=C2=A0 0.000014] tsc: Detected 2904.008 MHz processor
>>> [=C2=A0=C2=A0=C2=A0 0.004273] last_pfn =3D 0x3ffdf max_arch_pfn =3D 0x4=
00000000
>>> [=C2=A0=C2=A0=C2=A0 0.004315] MTRR map: 4 entries (3 fixed + 1 variable=
; max 19), built from 8 variable MTRRs
>>> [=C2=A0=C2=A0=C2=A0 0.004323] x86/PAT: Configuration [0-7]: WB=C2=A0 WC=
=C2=A0 UC- UC=C2=A0 WB=C2=A0 WPUC- WT
>>> [=C2=A0=C2=A0=C2=A0 0.012972] found SMP MP-table at [mem 0x000f5480-0x0=
00f548f]
>>> [=C2=A0=C2=A0=C2=A0 0.013243] ACPI: Early table checksum verification d=
isabled
>>> [=C2=A0=C2=A0=C2=A0 0.013252] ACPI: RSDP 0x00000000000F52C0 000014 (v00=
 BOCHS )
>>> [=C2=A0=C2=A0=C2=A0 0.013265] ACPI: RSDT 0x000000003FFE2357 000038 (v01=
 BOCHS=C2=A0 BXPC 00000001 BXPC 00000001)
>>> [=C2=A0=C2=A0=C2=A0 0.013283] ACPI: FACP 0x000000003FFE2147 0000F4 (v03=
 BOCHS=C2=A0 BXPC 00000001 BXPC 00000001)
>>> [=C2=A0=C2=A0=C2=A0 0.013304] ACPI: DSDT 0x000000003FFE0040 002107 (v01=
 BOCHS=C2=A0 BXPC 00000001 BXPC 00000001)
>>> [=C2=A0=C2=A0=C2=A0 0.013319] ACPI: FACS 0x000000003FFE0000 000040
>>> [=C2=A0=C2=A0=C2=A0 0.013331] ACPI: APIC 0x000000003FFE223B 000080 (v03=
 BOCHS=C2=A0 BXPC 00000001 BXPC 00000001)
>>> [=C2=A0=C2=A0=C2=A0 0.013346] ACPI: HPET 0x000000003FFE22BB 000038 (v01=
 BOCHS=C2=A0 BXPC 00000001 BXPC 00000001)
>>> [=C2=A0=C2=A0=C2=A0 0.013361] ACPI: MCFG 0x000000003FFE22F3 00003C (v01=
 BOCHS=C2=A0 BXPC 00000001 BXPC 00000001)
>>> [=C2=A0=C2=A0=C2=A0 0.013375] ACPI: WAET 0x000000003FFE232F 000028 (v01=
 BOCHS=C2=A0 BXPC 00000001 BXPC 00000001)
>>> [=C2=A0=C2=A0=C2=A0 0.013388] ACPI: Reserving FACP table memory at [mem=
 0x3ffe2147-0x3ffe223a]
>>> [=C2=A0=C2=A0=C2=A0 0.013393] ACPI: Reserving DSDT table memory at [mem=
 0x3ffe0040-0x3ffe2146]
>>> [=C2=A0=C2=A0=C2=A0 0.013398] ACPI: Reserving FACS table memory at [mem=
 0x3ffe0000-0x3ffe003f]
>>> [=C2=A0=C2=A0=C2=A0 0.013402] ACPI: Reserving APIC table memory at [mem=
 0x3ffe223b-0x3ffe22ba]
>>> [=C2=A0=C2=A0=C2=A0 0.013407] ACPI: Reserving HPET table memory at [mem=
 0x3ffe22bb-0x3ffe22f2]
>>> [=C2=A0=C2=A0=C2=A0 0.013411] ACPI: Reserving MCFG table memory at [mem=
 0x3ffe22f3-0x3ffe232e]
>>> [=C2=A0=C2=A0=C2=A0 0.013416] ACPI: Reserving WAET table memory at [mem=
 0x3ffe232f-0x3ffe2356]
>>> [=C2=A0=C2=A0=C2=A0 0.013746] No NUMA configuration found
>>> [=C2=A0=C2=A0=C2=A0 0.013750] Faking a node at [mem 0x0000000000000000-=
0x000000003ffdefff]
>>> [=C2=A0=C2=A0=C2=A0 0.013762] NODE_DATA(0) allocated [mem 0x3ffb4000-0x=
3ffdefff]
>>> [=C2=A0=C2=A0=C2=A0 0.015042] Zone ranges:
>>> [=C2=A0=C2=A0=C2=A0 0.015047]=C2=A0=C2=A0 DMA=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0 [mem 0x0000000000001000-0x0000000000ffffff]
>>> [=C2=A0=C2=A0=C2=A0 0.015056]=C2=A0=C2=A0 DMA32=C2=A0=C2=A0=C2=A0 [mem =
0x0000000001000000-0x000000003ffdefff]
>>> [=C2=A0=C2=A0=C2=A0 0.015067]=C2=A0=C2=A0 Normal=C2=A0=C2=A0 empty
>>> [=C2=A0=C2=A0=C2=A0 0.015073]=C2=A0=C2=A0 Device=C2=A0=C2=A0 empty
>>> [=C2=A0=C2=A0=C2=A0 0.015080] Movable zone start for each node
>>> [=C2=A0=C2=A0=C2=A0 0.015113] Early memory node ranges
>>> [=C2=A0=C2=A0=C2=A0 0.015116]=C2=A0=C2=A0 node=C2=A0=C2=A0 0: [mem 0x00=
00000000001000-0x000000000009efff]
>>> [=C2=A0=C2=A0=C2=A0 0.015122]=C2=A0=C2=A0 node=C2=A0=C2=A0 0: [mem 0x00=
00000000100000-0x000000003ffdefff]
>>> [=C2=A0=C2=A0=C2=A0 0.015128] Initmem setup node 0 [mem 0x0000000000001=
000-0x000000003ffdefff]
>>> [=C2=A0=C2=A0=C2=A0 0.015177] On node 0, zone DMA: 1 pages in unavailab=
le ranges
>>> [=C2=A0=C2=A0=C2=A0 0.015913] On node 0, zone DMA: 97 pages in unavaila=
ble ranges
>>> [=C2=A0=C2=A0=C2=A0 0.028914] On node 0, zone DMA32: 33 pages in unavai=
lable ranges
>>> [=C2=A0=C2=A0=C2=A0 0.029456] ACPI: PM-Timer IO Port: 0x608
>>> [=C2=A0=C2=A0=C2=A0 0.029493] ACPI: LAPIC_NMI (acpi_id[0xff] dfl dfl li=
nt[0x1])
>>> [=C2=A0=C2=A0=C2=A0 0.029547] IOAPIC[0]: apic_id 0, version 17, address=
 0xfec00000, GSI 0-23
>>> [=C2=A0=C2=A0=C2=A0 0.029558] ACPI: INT_SRC_OVR (bus 0 bus_irq 0 global=
_irq 2 dfl dfl)
>>> [=C2=A0=C2=A0=C2=A0 0.029564] ACPI: INT_SRC_OVR (bus 0 bus_irq 5 global=
_irq 5 high level)
>>> [=C2=A0=C2=A0=C2=A0 0.029569] ACPI: INT_SRC_OVR (bus 0 bus_irq 9 global=
_irq 9 high level)
>>> [=C2=A0=C2=A0=C2=A0 0.029575] ACPI: INT_SRC_OVR (bus 0 bus_irq 10 globa=
l_irq 10 high level)
>>> [=C2=A0=C2=A0=C2=A0 0.029580] ACPI: INT_SRC_OVR (bus 0 bus_irq 11 globa=
l_irq 11 high level)
>>> [=C2=A0=C2=A0=C2=A0 0.029597] ACPI: Using ACPI (MADT) for SMP configura=
tion information
>>> [=C2=A0=C2=A0=C2=A0 0.029602] ACPI: HPET id: 0x8086a201 base: 0xfed0000=
0
>>> [=C2=A0=C2=A0=C2=A0 0.029624] CPU topo: Max. logical packages:=C2=A0=C2=
=A0 1
>>> [=C2=A0=C2=A0=C2=A0 0.029628] CPU topo: Max. logical dies:=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0 1
>>> [=C2=A0=C2=A0=C2=A0 0.029631] CPU topo: Max. dies per package:=C2=A0=C2=
=A0 1
>>> [=C2=A0=C2=A0=C2=A0 0.029644] CPU topo: Max. threads per core:=C2=A0=C2=
=A0 1
>>> [=C2=A0=C2=A0=C2=A0 0.029647] CPU topo: Num. cores per package:=C2=A0=
=C2=A0=C2=A0=C2=A0 2
>>> [=C2=A0=C2=A0=C2=A0 0.029650] CPU topo: Num. threads per package:=C2=A0=
=C2=A0 2
>>> [=C2=A0=C2=A0=C2=A0 0.029653] CPU topo: Allowing 2 present CPUs plus 0 =
hotplug CPUs
>>> [=C2=A0=C2=A0=C2=A0 0.029679] kvm-guest: APIC: eoi() replaced with kvm_=
guest_apic_eoi_write()
>>> [=C2=A0=C2=A0=C2=A0 0.029726] PM: hibernation: Registered nosave memory=
: [mem 0x00000000-0x00000fff]
>>> [=C2=A0=C2=A0=C2=A0 0.029734] PM: hibernation: Registered nosave memory=
: [mem 0x0009f000-0x0009ffff]
>>> [=C2=A0=C2=A0=C2=A0 0.029738] PM: hibernation: Registered nosave memory=
: [mem 0x000a0000-0x000effff]
>>> [=C2=A0=C2=A0=C2=A0 0.029742] PM: hibernation: Registered nosave memory=
: [mem 0x000f0000-0x000fffff]
>>> [=C2=A0=C2=A0=C2=A0 0.029749] [mem 0x40000000-0xafffffff] available for=
 PCI devices
>>> [=C2=A0=C2=A0=C2=A0 0.029753] Booting paravirtualized kernel on KVM
>>> [=C2=A0=C2=A0=C2=A0 0.029758] clocksource: refined-jiffies: mask: 0xfff=
fffff max_cycles: 0xffffffff, max_idle_ns: 7645519600211568 ns
>>> [=C2=A0=C2=A0=C2=A0 0.035898] setup_percpu: NR_CPUS:8192 nr_cpumask_bit=
s:2 nr_cpu_ids:2 nr_node_ids:1
>>> [=C2=A0=C2=A0=C2=A0 0.036314] percpu: Embedded 65 pages/cpu s229376 r81=
92 d28672 u1048576
>>> [=C2=A0=C2=A0=C2=A0 0.036436] kvm-guest: PV spinlocks disabled, no host=
 support
>>> [=C2=A0=C2=A0=C2=A0 0.036440] Kernel command line: root=3D/dev/sda1 con=
sole=3DttyS0
>>> [=C2=A0=C2=A0=C2=A0 0.036669] Dentry cache hash table entries: 131072 (=
order: 8, 1048576 bytes, linear)
>>> [=C2=A0=C2=A0=C2=A0 0.036739] Inode-cache hash table entries: 65536 (or=
der: 7, 524288 bytes, linear)
>>> [=C2=A0=C2=A0=C2=A0 0.036830] Fallback order for Node 0: 0
>>> [=C2=A0=C2=A0=C2=A0 0.036839] Built 1 zonelists, mobility grouping on.=
=C2=A0 Total pages: 257759
>>> [=C2=A0=C2=A0=C2=A0 0.036844] Policy zone: DMA32
>>> [=C2=A0=C2=A0=C2=A0 0.036875] mem auto-init: stack:all(zero), heap allo=
c:on, heap free:off
>>> [=C2=A0=C2=A0=C2=A0 0.042521] Memory: 260860K/1048052K available (22528=
K kernel code, 2386K rwdata, 6124K rodata, 6304K init, 8064K bss, 70584K re=
served, 0K cma-reserved)
>>> [=C2=A0=C2=A0=C2=A0 0.056267] SLUB: HWalign=3D64, Order=3D0-3, MinObjec=
ts=3D0, CPUs=3D2, Nodes=3D1
>>> [=C2=A0=C2=A0=C2=A0 0.056279] kmemleak: Kernel memory leak detector dis=
abled
>>> [=C2=A0=C2=A0=C2=A0 0.056484] Kernel/User page tables isolation: enable=
d
>>> [=C2=A0=C2=A0=C2=A0 0.056631] ftrace: allocating 43400 entries in 170 p=
ages
>>> [=C2=A0=C2=A0=C2=A0 0.065090] ftrace: allocated 170 pages with 4 groups
>>> [=C2=A0=C2=A0=C2=A0 0.066107] Dynamic Preempt: voluntary
>>> [=C2=A0=C2=A0=C2=A0 0.066496] rcu: Preemptible hierarchical RCU impleme=
ntation.
>>> [=C2=A0=C2=A0=C2=A0 0.066500] rcu:=C2=A0=C2=A0=C2=A0=C2=A0 RCU restrict=
ing CPUs from NR_CPUS=3D8192 to nr_cpu_ids=3D2.
>>> [=C2=A0=C2=A0=C2=A0 0.066505]=C2=A0 Trampoline variant of Tasks RCU ena=
bled.
>>> [=C2=A0=C2=A0=C2=A0 0.066508]=C2=A0 Rude variant of Tasks RCU enabled.
>>> [=C2=A0=C2=A0=C2=A0 0.066510]=C2=A0 Tracing variant of Tasks RCU enable=
d.
>>> [=C2=A0=C2=A0=C2=A0 0.066513] rcu: RCU calculated value of scheduler-en=
listment delay is 25 jiffies.
>>> [=C2=A0=C2=A0=C2=A0 0.066517] rcu: Adjusting geometry for rcu_fanout_le=
af=3D16, nr_cpu_ids=3D2
>>> [=C2=A0=C2=A0=C2=A0 0.066535] RCU Tasks: Setting shift to 1 and lim to =
1 rcu_task_cb_adjust=3D1.
>>> [=C2=A0=C2=A0=C2=A0 0.066541] RCU Tasks Rude: Setting shift to 1 and li=
m to 1 rcu_task_cb_adjust=3D1.
>>> [=C2=A0=C2=A0=C2=A0 0.066546] RCU Tasks Trace: Setting shift to 1 and l=
im to 1 rcu_task_cb_adjust=3D1.
>>> [=C2=A0=C2=A0=C2=A0 0.079398] NR_IRQS: 524544, nr_irqs: 440, preallocat=
ed irqs: 16
>>> [=C2=A0=C2=A0=C2=A0 0.079764] rcu: srcu_init: Setting srcu_struct sizes=
 based on contention.
>>> [=C2=A0=C2=A0=C2=A0 0.091718] Console: colour VGA+ 80x25
>>> [=C2=A0=C2=A0=C2=A0 0.091774] printk: legacy console [ttyS0] enabled
>>> [=C2=A0=C2=A0=C2=A0 0.232004] ACPI: Core revision 20230628
>>> [=C2=A0=C2=A0=C2=A0 0.233211] clocksource: hpet: mask: 0xffffffff max_c=
ycles: 0xffffffff, max_idle_ns: 19112604467 ns
>>> [=C2=A0=C2=A0=C2=A0 0.234715] APIC: Switch to symmetric I/O mode setup
>>> [=C2=A0=C2=A0=C2=A0 0.235721] x2apic enabled
>>> [=C2=A0=C2=A0=C2=A0 0.236578] APIC: Switched APIC routing to: physical =
x2apic
>>> [=C2=A0=C2=A0=C2=A0 0.239656] ..TIMER: vector=3D0x30 apic1=3D0 pin1=3D2=
 apic2=3D-1 pin2=3D-1
>>> [=C2=A0=C2=A0=C2=A0 0.241221] clocksource: tsc-early: mask: 0xfffffffff=
fffffff max_cycles: 0x29dc0d988f1, max_idle_ns: 440795328788 ns
>>> [=C2=A0=C2=A0=C2=A0 0.243872] Calibrating delay loop (skipped) preset v=
alue.. 5808.01 BogoMIPS (lpj=3D11616032)
>>> [=C2=A0=C2=A0=C2=A0 0.246030] Last level iTLB entries: 4KB 0, 2MB 0, 4M=
B 0
>>> [=C2=A0=C2=A0=C2=A0 0.247870] Last level dTLB entries: 4KB 0, 2MB 0, 4M=
B 0, 1GB 0
>>> [=C2=A0=C2=A0=C2=A0 0.248788] Spectre V1 : Mitigation: usercopy/swapgs =
barriers and __user pointer sanitization
>>> [=C2=A0=C2=A0=C2=A0 0.250127] Spectre V2 : Mitigation: Retpolines
>>> [=C2=A0=C2=A0=C2=A0 0.251176] Spectre V2 : Spectre v2 / SpectreRSB miti=
gation: Filling RSB on context switch
>>> [=C2=A0=C2=A0=C2=A0 0.251868] Spectre V2 : Spectre v2 / SpectreRSB : Fi=
lling RSB on VMEXIT
>>> [=C2=A0=C2=A0=C2=A0 0.253483] Speculative Store Bypass: Vulnerable
>>> [=C2=A0=C2=A0=C2=A0 0.255878] MDS: Vulnerable: Clear CPU buffers attemp=
ted, no microcode
>>> [=C2=A0=C2=A0=C2=A0 0.257191] MMIO Stale Data: Unknown: No mitigations
>>> [=C2=A0=C2=A0=C2=A0 0.258243] x86/fpu: x87 FPU will use FXSAVE
>>> [=C2=A0=C2=A0=C2=A0 0.327550] Freeing SMP alternatives memory: 36K
>>> [=C2=A0=C2=A0=C2=A0 0.327884] pid_max: default: 32768 minimum: 301
>>> [=C2=A0=C2=A0=C2=A0 0.330232] LSM: initializing lsm=3Dcapability,landlo=
ck,apparmor,tomoyo,bpf,ima,evm
>>> [=C2=A0=C2=A0=C2=A0 0.332326] landlock: Up and running.
>>> [=C2=A0=C2=A0=C2=A0 0.333534] AppArmor: AppArmor initialized
>>> [=C2=A0=C2=A0=C2=A0 0.334523] TOMOYO Linux initialized
>>> [=C2=A0=C2=A0=C2=A0 0.335895] LSM support for eBPF active
>>> [=C2=A0=C2=A0=C2=A0 0.337311] Mount-cache hash table entries: 2048 (ord=
er: 2, 16384 bytes, linear)
>>> [=C2=A0=C2=A0=C2=A0 0.339886] Mountpoint-cache hash table entries: 2048=
 (order: 2, 16384 bytes, linear)
>>> [=C2=A0=C2=A0=C2=A0 0.344459] kcsan: enabled early
>>> [=C2=A0=C2=A0=C2=A0 0.345245] kcsan: non-strict mode configured - use C=
ONFIG_KCSAN_STRICT=3Dy to see all data races
>>> [=C2=A0=C2=A0=C2=A0 0.375873] BUG: unable to handle page fault for addr=
ess: 0000000000030368
>>> [=C2=A0=C2=A0=C2=A0 0.377316] #PF: supervisor read access in kernel mod=
e
>>> [=C2=A0=C2=A0=C2=A0 0.378506] #PF: error_code(0x0000) - not-present pag=
e
>>> [=C2=A0=C2=A0=C2=A0 0.379647] PGD 0 P4D 0
>>> [=C2=A0=C2=A0=C2=A0 0.379861] Oops: 0000 [#1] PREEMPT SMP PTI
>>> [=C2=A0=C2=A0=C2=A0 0.379861] CPU: 0 PID: 1 Comm: swapper/0 Not tainted=
 6.9.0-rc1+ #75
>>> [=C2=A0=C2=A0=C2=A0 0.379861] Hardware name: QEMU Standard PC (Q35 + IC=
H9, 2009), BIOS 1.16.3-debian-1.16.3-2 04/01/2014
>>> [=C2=A0=C2=A0=C2=A0 0.379861] RIP: 0010:kcsan_setup_watchpoint+0x3cc/0x=
400
>>> [=C2=A0=C2=A0=C2=A0 0.379861] Code: 8b 04 24 4c 89 c2 48 31 c2 e9 69 fe=
 ff ff 45 31 c0 e9 c3 fd ff ff 4c 89 c2 31 c0 e9 57 fe ff ff 45 0f b6 04 24=
 e9 af fd ff ff <45> 8b 04 24 e9 a6 fd ff ff 85 c9 74 08 f0 48 ff 05 b7 a2 =
6e 02 b9
>>> [=C2=A0=C2=A0=C2=A0 0.379861] RSP: 0000:ffff9fed80003de0 EFLAGS: 000100=
46
>>> [=C2=A0=C2=A0=C2=A0 0.379861] RAX: 0000000000000000 RBX: ffff8c2d3ec302=
c0 RCX: 0000000000000030
>>> [=C2=A0=C2=A0=C2=A0 0.379861] RDX: 0000000000000001 RSI: ffffffff995ff0=
f0 RDI: 0000000000000000
>>> [=C2=A0=C2=A0=C2=A0 0.379861] RBP: 0000000000000004 R08: 00000000aaaaaa=
ab R09: 0000000000000000
>>> [=C2=A0=C2=A0=C2=A0 0.379861] R10: 0000000000030368 R11: 00080000000303=
68 R12: 0000000000030368
>>> [=C2=A0=C2=A0=C2=A0 0.379861] R13: 0000000000000031 R14: 00000000000000=
00 R15: 0000000000000000
>>> [=C2=A0=C2=A0=C2=A0 0.379861] FS:=C2=A0 0000000000000000(0000) GS:ffff8=
c2d3ec00000(0000) knlGS:0000000000000000
>>> [=C2=A0=C2=A0=C2=A0 0.379861] CS:=C2=A0 0010 DS: 0000 ES: 0000 CR0: 000=
0000080050033
>>> [=C2=A0=C2=A0=C2=A0 0.379861] CR2: 0000000000030368 CR3: 0000000030a200=
00 CR4: 00000000000006f0
>>> [=C2=A0=C2=A0=C2=A0 0.379861] Call Trace:
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 <IRQ>
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? __die+0x23/0x70
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? page_fault_oops+0x173/0x4f0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? exc_page_fault+0x81/0x190
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? asm_exc_page_fault+0x26/0x30
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? perf_event_task_tick+0x40/0x130
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? kcsan_setup_watchpoint+0x3cc/0x40=
0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? update_load_avg+0x7e/0x7e0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? __hrtimer_run_queues+0x3e/0x4b0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? hrtimer_active+0x88/0xc0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 perf_event_task_tick+0x40/0x130
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 scheduler_tick+0xe3/0x2a0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 update_process_times+0xb4/0xe0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 tick_periodic+0x4e/0x110
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 tick_handle_periodic+0x39/0x90
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? __pfx_timer_interrupt+0x10/0x10
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 timer_interrupt+0x18/0x30
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 __handle_irq_event_percpu+0x7b/0x28=
0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 handle_irq_event+0x78/0xf0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 handle_edge_irq+0x11e/0x400
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 __common_interrupt+0x3f/0xa0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 common_interrupt+0x80/0xa0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 </IRQ>
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 <TASK>
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 asm_common_interrupt+0x26/0x40
>>> [=C2=A0=C2=A0=C2=A0 0.379861] RIP: 0010:__tsan_read4+0x34/0x110
>>> [=C2=A0=C2=A0=C2=A0 0.379861] Code: 4c 8b 1c 24 48 b9 ff ff ff ff ff ff=
 01 00 48 c1 e8 09 49 21 ca 25 f8 01 00 00 4c 8d 80 60 e8 cc 9b 48 05 78 e8=
 cc 9b 4d 8b 08 <4d> 85 c9 79 2a 4c 89 ca 4c 89 ce 48 c1 ea 31 48 21 ce 81 =
e2 ff 3f
>>> [=C2=A0=C2=A0=C2=A0 0.379861] RSP: 0000:ffff9fed80013e18 EFLAGS: 000002=
96
>>> [=C2=A0=C2=A0=C2=A0 0.379861] RAX: ffffffff9bcce890 RBX: 000000012dbb5e=
d6 RCX: 0001ffffffffffff
>>> [=C2=A0=C2=A0=C2=A0 0.379861] RDX: 0000000000098472 RSI: ffffffff9b65df=
00 RDI: ffffffff9b043f64
>>> [=C2=A0=C2=A0=C2=A0 0.379861] RBP: 0000000000b13f20 R08: ffffffff9bcce8=
78 R09: 0000000000000000
>>> [=C2=A0=C2=A0=C2=A0 0.379861] R10: 0001ffff9b043f64 R11: ffffffff9b65df=
00 R12: 00000000fffedb23
>>> [=C2=A0=C2=A0=C2=A0 0.379861] R13: 0000000000000000 R14: ffff8c2d3ec000=
00 R15: 00000000002c4fc8
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? setup_boot_APIC_clock+0x180/0x8f0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? setup_boot_APIC_clock+0x180/0x8f0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 setup_boot_APIC_clock+0x180/0x8f0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 native_smp_prepare_cpus+0x2b/0xc0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 kernel_init_freeable+0x41e/0x7d0
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? __pfx_kernel_init+0x10/0x10
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 kernel_init+0x1f/0x230
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ret_from_fork+0x34/0x50
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ? __pfx_kernel_init+0x10/0x10
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 ret_from_fork_asm+0x1a/0x30
>>> [=C2=A0=C2=A0=C2=A0 0.379861]=C2=A0 </TASK>
>>> [=C2=A0=C2=A0=C2=A0 0.379861] Modules linked in:
>>> [=C2=A0=C2=A0=C2=A0 0.379861] CR2: 0000000000030368
>>> [=C2=A0=C2=A0=C2=A0 0.379861] ---[ end trace 0000000000000000 ]---
>>> [=C2=A0=C2=A0=C2=A0 0.379861] RIP: 0010:kcsan_setup_watchpoint+0x3cc/0x=
400
>>> [=C2=A0=C2=A0=C2=A0 0.379861] Code: 8b 04 24 4c 89 c2 48 31 c2 e9 69 fe=
 ff ff 45 31 c0 e9 c3 fd ff ff 4c 89 c2 31 c0 e9 57 fe ff ff 45 0f b6 04 24=
...
>>> [=C2=A0=C2=A0=C2=A0 0.379861] CR2: 0000000000030368 CR3: 0000000030a200=
00 CR4: 00000000000006f0
>>> [=C2=A0=C2=A0=C2=A0 0.379861] Kernel panic - not syncing: Fatal excepti=
on in interrupt
>>> [=C2=A0=C2=A0=C2=A0 0.379861] ---[ end Kernel panic - not syncing: Fata=
...
kasan-dev/782006d6-c3f1-4f61-aa40-e9b3903bdbf4%40molgen.mpg.de.
