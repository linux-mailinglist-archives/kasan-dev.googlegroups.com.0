Return-Path: <kasan-dev+bncBCZ35CE25UGBBVOM7SKQMGQEWRXFO2A@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-ot1-x339.google.com (mail-ot1-x339.google.com [IPv6:2607:f8b0:4864:20::339])
	by mail.lfdr.de (Postfix) with ESMTPS id DCAC1563851
	for <lists+kasan-dev@lfdr.de>; Fri,  1 Jul 2022 18:52:39 +0200 (CEST)
Received: by mail-ot1-x339.google.com with SMTP id v35-20020a056830092300b00616cce37d8asf1435831ott.1
        for <lists+kasan-dev@lfdr.de>; Fri, 01 Jul 2022 09:52:39 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1656694358; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        bh=DPqhH6gqG+d8ZlBCylHCcCjaSKnMf4DSmmn9jDxbuGQ=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@kernel.org header.s=k20201202 header.b=SqfCvn1k;
       spf=pass (google.com: domain of jic23@kernel.org designates 2604:1380:4641:c500::1 as permitted sender) smtp.mailfrom=jic23@kernel.org;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=DPqhH6gqG+d8ZlBCylHCcCjaSKnMf4DSmmn9jDxbuGQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=DPqhH6gqG+d8ZlBCylHCcCjaSKnMf4DSmmn9jDxbuGQ=;
        b=
Sender: kasan-dev@googlegroups.com
X-Gm-Message-State: AJIora9R5xIF+wVOiNeDfxK9/LG1J4iithGQPShRaDTVxbVedUuFk188
	HMNDGIdZzliTa2FkyW7LPmo=
X-Google-Smtp-Source: AGRyM1uhb6kVMvH7lPqhRY4DzBH9K5eN+UShJTb67ovnVQlwH74ZTdt3uZrp5LhZ5+gufKky3NqEog==
X-Received: by 2002:aca:b708:0:b0:32f:5106:f0af with SMTP id h8-20020acab708000000b0032f5106f0afmr10627574oif.244.1656694358155;
        Fri, 01 Jul 2022 09:52:38 -0700 (PDT)
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a05:6870:44cb:b0:102:7ae:aca9 with SMTP id
 t11-20020a05687044cb00b0010207aeaca9ls12042416oai.9.gmail; Fri, 01 Jul 2022
 09:52:37 -0700 (PDT)
X-Received: by 2002:a05:6870:3102:b0:101:15a2:9d7f with SMTP id v2-20020a056870310200b0010115a29d7fmr8952752oaa.36.1656694357407;
        Fri, 01 Jul 2022 09:52:37 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1656694357; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:subject:cc:to:from:date:dkim-signature;
        bh=xzDVsiXP2TosKdxKCw2uS7OhdSUMRqCKJ2wszTS3Mb4=;
        b=
...
Received: from dfw.source.kernel.org (dfw.source.kernel.org. [2604:1380:4641:c500::1])
        by gmr-mx.google.com with ESMTPS id j24-20020a056808057800b0032f15fa78efsi1033131oig.4.2022.07.01.09.52.37
        for <kasan-dev@googlegroups.com>
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Fri, 01 Jul 2022 09:52:37 -0700 (PDT)
Received-SPF: pass (google.com: domain of jic23@kernel.org designates 2604:1380:4641:c500::1 as permitted sender) client-ip=2604:1380:4641:c500::1;
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.source.kernel.org (Postfix) with ESMTPS id 51D8D625F7;
...
Cc: Wolfram Sang <wsa@kernel.org>, Uwe =?UTF-8?B?S2xlaW5lLUvDtm5pZw==?=
 ...
 Kevin Tsai <ktsai@capellamicro.com>, Crt Mori <cmo@melexis.com>, Dmitry
 Torokhov <dmitry.torokhov@gmail.com>, Nick Dyer <nick@shmanahar.org>,
 Bastien Nocera <hadess@hadess.net>, Hans de Goede <hdegoede@redhat.com>,
 Maxime Coquelin <mcoquelin.stm32@gmail.com>, Alexandre Torgue
 <alexandre.torgue@foss.st.com>, Sakari Ailus
 <sakari.ailus@linux.intel.com>, Pavel Machek <pavel@ucw.cz>, Jan-Simon
 Moeller <jansimon.moeller@gmx.de>, Marek =?UTF-8?B?QmVow7pu?=
...
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@kernel.org header.s=k20201202 header.b=SqfCvn1k;       spf=pass
 (google.com: domain of jic23@kernel.org designates 2604:1380:4641:c500::1 as
 permitted sender) smtp.mailfrom=jic23@kernel.org;       dmarc=pass (p=NONE
...
> =20
>  	if (!chip) {
>  		dev_crit(dev, "Could not get client data at remove, memory corruption =
ahead\n");
> -		return 0;
> +		return;
>  	}
...
>  {
>  	struct atmel_i2c_client_priv *i2c_priv =3D i2c_get_clientdata(client);
> =20
...
>  {
>  	struct pca953x_platform_data *pdata =3D dev_get_platdata(&client->dev);
...
>  {
>  	struct pcf857x_platform_data	*pdata =3D dev_get_platdata(&client->dev);
>  	struct pcf857x			*gpio =3D i2c_get_clientdata(client);
...
>  	if (ret)
>  		dev_warn(&client->dev, "Failed to put device in stand-by mode (%pe), i=
gnoring\n",
>  			 ERR_PTR(ret));
> -
> -	return 0;
...
>  {
>  	struct lp3944_platform_data *pdata =3D dev_get_platdata(&client->dev);
...
>  {
>  	struct max9286_priv *priv =3D sd_to_max9286(i2c_get_clientdata(client))=
;
> =20
...
>  {
>  	struct rdacm21_device *dev =3D sd_to_rdacm21(i2c_get_clientdata(client)=
);
> =20
...
>  	ret =3D regmap_update_bits(regmap, RT4831_REG_ENABLE, RT4831_RESET_MASK=
, RT4831_RESET_MASK);
>  	if (ret)
...
>  	struct lis3lv02d_platform_data *pdata =3D client->dev.platform_data;
...
>  {
>  	struct nfcmrvl_i2c_drv_data *drv_data =3D i2c_get_clientdata(client);
> =20
...
>  	ret =3D regmap_bulk_write(chip->regmap, DA9121_REG_SYS_MASK_0, mask_all=
, 4);
>  	if (ret !=3D 0)
...
kasan-dev/20220701180057.434aa9ef%40jic23-huawei.
