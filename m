Return-Path: <kasan-dev+bncBCPILY4NUAFBBRGRUP3QKGQEJVLVU2I@googlegroups.com>
X-Original-To: lists+kasan-dev@lfdr.de
Delivered-To: lists+kasan-dev@lfdr.de
Received: from mail-pf1-x437.google.com (mail-pf1-x437.google.com [IPv6:2607:f8b0:4864:20::437])
	by mail.lfdr.de (Postfix) with ESMTPS id 845751FB721
	for <lists+kasan-dev@lfdr.de>; Tue, 16 Jun 2020 17:44:06 +0200 (CEST)
Received: by mail-pf1-x437.google.com with SMTP id q24sf16089520pfs.7
        for <lists+kasan-dev@lfdr.de>; Tue, 16 Jun 2020 08:44:06 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1592322245; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:references:in-reply-to:message-id
         :date:subject:cc:to:from:mime-version:sender:dkim-signature;
        bh=BGBh9j1SFhvPe2PFEeePur81uqsIJcn7nrOsVmYPNJM=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       dkim=pass header.i=@redhat.com header.s=mimecast20190719 header.b=TRTpHlr2;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=BGBh9j1SFhvPe2PFEeePur81uqsIJcn7nrOsVmYPNJM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=sender:x-gm-message-state:mime-version:from:to:cc:subject:date
         ...
         :list-subscribe:list-unsubscribe;
        bh=BGBh9j1SFhvPe2PFEeePur81uqsIJcn7nrOsVmYPNJM=;
        b=
Sender: kasan-dev@googlegroups.com
X-Gm-Message-State: AOAM533kk6g+OysJ7aaJB7JOFqR3eTIVd8NFYl5OdSaq1mM3Ummkrf4K
	ZrjpqhOIAUu8Ljzj2zz0aHQ=
X-Google-Smtp-Source: ABdhPJw2gaBID2ekJqTItkbdfZ7cERYWdVkdTIJEqMJjfQnsvVNxYrlpr5EelzIIShcCkcxOEK5sjg==
X-Received: by 2002:a17:90b:1292:: with SMTP id fw18mr3308158pjb.183.1592322245033;
        Tue, 16 Jun 2020 08:44:05 -0700 (PDT)
MIME-Version: 1.0
X-BeenThere: kasan-dev@googlegroups.com
Received: by 2002:a17:902:7b91:: with SMTP id w17ls6334192pll.10.gmail; Tue,
 16 Jun 2020 08:44:04 -0700 (PDT)
X-Received: by 2002:a17:90a:3606:: with SMTP id s6mr3790279pjb.118.1592322244474;
        Tue, 16 Jun 2020 08:44:04 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1592322244; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=references:in-reply-to:message-id:date:subject:cc:to:from
         :dkim-signature;
        bh=PqtRZj4ruq11QAXahIQZePjt28FPH9XAHtIshBznrXA=;
        b=
...
Received: from us-smtp-1.mimecast.com (us-smtp-delivery-1.mimecast.com. [207.211.31.120])
        by gmr-mx.google.com with ESMTPS id l9si86251pjw.2.2020.06.16.08.44.04
...
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 ...
 us-mta-311-EkGQMPPrO1CKphJzqQJVcA-1; Tue, 16 Jun 2020 11:44:00 -0400
X-MC-Unique: EkGQMPPrO1CKphJzqQJVcA-1
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by mimecast-mx01.redhat.com (Postfix) with ESMTPS id B5BBE8DEEF2;
	Tue, 16 Jun 2020 15:43:55 +0000 (UTC)
Received: from llong.com (ovpn-114-156.rdu2.redhat.com [10.10.114.156])
	by smtp.corp.redhat.com (Postfix) with ESMTP id D206A60C05;
...
Subject: [PATCH v5 2/2] mm, treewide: Rename kzfree() to kfree_sensitive()
Date: Tue, 16 Jun 2020 11:43:11 -0400
Message-Id: <20200616154311.12314-3-longman@redhat.com>
...
X-Original-Authentication-Results: gmr-mx.google.com;       dkim=pass
 header.i=@redhat.com header.s=mimecast20190719 header.b=TRTpHlr2;
...
---
 ...
 115 files changed, 322 insertions(+), 320 deletions(-)
...
index edcf690800d4..58f66ba09dac 100644
--- a/crypto/api.c
+++ b/crypto/api.c
...
index 37526eb8c5d5..23ce5b55f40b 100644
--- a/crypto/drbg.c
+++ b/crypto/drbg.c
...
index c89cb2ee2496..a1d175589e18 100644
...
index 872ea3ff1c6b..110456e06c5e 100644
...
index cb8a6ea2a4bc..930fc802d399 100644
...
index 000ddfab5ba0..5799df0c6643 100644
...
index 81dc5ff08909..cb4a3c569802 100644
...
index 053cc34d2ca2..823de10479bd 100644
...
index 0f95009a30b6..ec9122070e58 100644
...
index 5fac34f192af..467db43d1e34 100644
--- a/fs/cifs/connect.c
+++ b/fs/cifs/connect.c
...
index 56791a692c8b..2393e8aec5c6 100644
--- a/fs/cifs/misc.c
+++ b/fs/cifs/misc.c
...
index e24eb48bfbe1..484086feea35 100644
...
index 4829d2367eda..8d036b54cbff 100644
...
index dc2c6a51d11a..e4d9a86b174b 100644
--- a/lib/test_kasan.c
+++ b/lib/test_kasan.c
...
index 37d48a56431d..aeedf241e2e6 100644
--- a/mm/slab_common.c
+++ b/mm/slab_common.c
...
index c2c5ab05fa7e..684e60e1915c 100644
...
index 6c4acf1f0220..8cf1a6a5cc5b 100644
--- a/net/core/sock.c
+++ b/net/core/sock.c
...
index d57e1a002ffc..3581ccee34d6 100644
--- a/net/sctp/socket.c
+++ b/net/sctp/socket.c
...
index c623d9bf5096..8e764e170c73 100644
...
index 263ae395ad44..d30cf356a412 100644
...
index 4d3b76f94f55..29adb1010c18 100644
...
To view this discussion on the web visit https://groups.google.com/d/msgid/kasan-dev/20200616154311.12314-3-longman%40redhat.com.
